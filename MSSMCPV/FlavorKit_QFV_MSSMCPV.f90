...
Subroutine CalculateBox2d2L(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,             & 
...
Complex(dp),Intent(in) :: cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),      & 
...
& cplcFdGluSdR(3,6),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,4,6),         & 
& cplcFeChiSeR(3,4,6),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),cplcFeFeVPL(3,3),            & 
...
& cplcFvFecHpmR(3,3,2),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplChiChihhL(4,4,4),        & 
& cplChiChihhR(4,4,4),cplChiChiVZL(4,4),cplChiChiVZR(4,4),cplChiFdcSdL(4,3,6),           & 
& cplChiFdcSdR(4,3,6),cplChiFecSeL(4,3,6),cplChiFecSeR(4,3,6),cplcHpmVPVWm(2),           & 
& cplcHpmVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),         & 
& cplhhcHpmVWm(4,2),cplhhcVWmVWm(4),cplhhhhhh(4,4,4),cplhhhhVZ(4,4),cplhhHpmcHpm(4,2,2), & 
& cplhhHpmcVWm(4,2),cplhhSdcSd(4,6,6),cplhhSecSe(4,6,6),cplhhSucSu(4,6,6),               & 
& cplhhSvcSv(4,3,3),cplhhVZVZ(4),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplHpmcVWmVP(2),    & 
...
Subroutine CalculatePengS2d2L(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,       & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,   & 
& cplcChaFecSvR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,         & 
...
Subroutine CalculatePengV2d2L(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,       & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,   & 
& cplcChaFecSvR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,         & 
...
Subroutine CalculateTreeS2d2L(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,       & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,   & 
& cplcChaFecSvR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,         & 
...
Subroutine CalculateTreeV2d2L(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,       & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,   & 
& cplcChaFecSvR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,         & 
...
Subroutine CalculateBox2d2nu(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,            & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
...
& cplSucSuVZ,cplSvcSvVZ,BOddvvVRR,BOddvvVLL,BOddvvVRL,BOddvvVLR)
...
& cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChiVZL(4,4),cplChiChiVZR(4,4),           & 
& cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),       & 
& cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplhhhhVZ(4,4),       & 
& cplhhVZVZ(4),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVZ(6,6),cplSecSeVZ(6,6),        & 
& cplSucSuVZ(6,6),cplSvcSvVZ(3,3)
...
Subroutine CalculatePengS2d2nu(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,          & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaVZL,       & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,             & 
...
& cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplhhhhVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,      & 
& cplSucSuVZ,cplSvcSvVZ,PSOddvvVRR,PSOddvvVLL,PSOddvvVRL,PSOddvvVLR)
...
Subroutine CalculatePengV2d2nu(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,          & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaVZL,       & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,             & 
...
& cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplhhhhVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,      & 
& cplSucSuVZ,cplSvcSvVZ,PVOddvvVRR,PVOddvvVLL,PVOddvvVRL,PVOddvvVLR)
...
Subroutine CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,          & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaVZL,       & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,             & 
...
& cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplhhhhVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,      & 
& cplSucSuVZ,cplSvcSvVZ,TSOddvvVRR,TSOddvvVLL,TSOddvvVRL,TSOddvvVLR)
...
Subroutine CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,          & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           & 
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaVZL,       & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,             & 
...
& cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplhhhhVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,      & 
& cplSucSuVZ,cplSvcSvVZ,TVOddvvVRR,TVOddvvVLL,TVOddvvVRL,TVOddvvVLR)
...
Subroutine CalculateBox4d(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,               & 
& MFd,MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,               & 
& MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,  & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
...
& cplSdcSdVP,cplSdcSdVZ,cplSucSuVG,cplSucSuVP,cplSucSuVZ,BO4dSLL,BO4dSRR,BO4dSRL,        & 
...
Implicit None 
Real(dp),Intent(in) :: MCha(2),MCha2(2),MChi(4),MChi2(4),MFd(3),MFd2(3),MFu(3),MFu2(3),MGlu,MGlu2,           & 
& Mhh(4),Mhh2(4),MHpm(2),MHpm2(2),MSd(6),MSd2(6),MSu(6),MSu2(6),MVWm,MVWm2,MVZ,MVZ2
...
& cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),               & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluGluVGL,            & 
& cplGluGluVGR,cplhhcHpmVWm(4,2),cplhhcVWmVWm(4),cplhhhhhh(4,4,4),cplhhhhVZ(4,4),        & 
& cplhhHpmcHpm(4,2,2),cplhhHpmcVWm(4,2),cplhhSdcSd(4,6,6),cplhhSucSu(4,6,6),             & 
& cplhhVZVZ(4),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),      & 
...
Subroutine CalculateTreeS4d(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,             & 
& MFd,MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,               & 
& MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,  & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,      & 
& cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSdVG,              & 
& cplSdcSdVP,cplSdcSdVZ,cplSucSuVG,cplSucSuVP,cplSucSuVZ,TSO4dSLL,TSO4dSRR,              & 
...
Subroutine CalculateTreeV4d(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,             & 
& MFd,MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,               & 
& MVWm2,MVZ,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,  & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,      & 
& cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSdVG,              & 
& cplSdcSdVP,cplSdcSdVZ,cplSucSuVG,cplSucSuVP,cplSucSuVZ,TVO4dSLL,TVO4dSRR,              & 
...
Subroutine CalculateTreeSdulv(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,             & 
& MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,  & 
...
& cplHpmcVWmVZ,cplHpmSvcSe,cplSvcSeVWm,TSOdulvSLL,TSOdulvSRR,TSOdulvSRL,TSOdulvSLR,      & 
...
& cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),               & 
...
& cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplcFuFuVPL(3,3),             & 
& cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFvChiSvL(3,4,3),cplcFvChiSvR(3,4,3),& 
...
& cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplhhcHpmVWm(4,2),& 
& cplhhcVWmVWm(4),cplhhHpmcHpm(4,2,2),cplhhHpmcVWm(4,2),cplHpmcHpmVP(2,2),               & 
& cplHpmcHpmVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmSvcSe(2,3,6),cplSvcSeVWm(3,6)
...
Subroutine CalculateTreeVdulv(gt1,gt2,gt3,gt4,OnlySM,MCha,MCha2,MChi,MChi2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,             & 
& MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,  & 
& cplcChaChiHpmL,cplcChaChiHpmR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFdcSuL,             & 
& cplcChaFdcSuR,cplcChaFecSvL,cplcChaFecSvR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,         & 
...
& cplChiFecSeR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplhhcHpmVWm,         & 
& cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,         & 
& cplHpmcVWmVZ,cplHpmSvcSe,cplSvcSeVWm,TVOdulvSLL,TVOdulvSRR,TVOdulvSRL,TVOdulvSLR,      & 
...
Subroutine CalculateGamma2Q(gt1,gt2,gt3,OnlySM,MCha,MCha2,MChi,MChi2,MFd,             & 
& MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcChaChaVPL,cplcChaChaVPR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,         & 
...
& cplHpmcVWmVP,cplSdcSdVP,cplSucSuVP,OA2qSL,OA2qSR,OA2qVL,OA2qVR)
...
& cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFdGluSdL(3,6),             & 
& cplcFdGluSdR(3,6),cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),        & 
& cplcFuFdcVWmR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplChiFdcSdL(4,3,6),              & 
& cplChiFdcSdR(4,3,6),cplcHpmVPVWm(2),cplcVWmVPVWm,cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),  & 
...
Subroutine CalculateGluon2Q(gt1,gt2,gt3,OnlySM,MCha,MCha2,MChi,MChi2,MFd,             & 
& MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,           & 
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,            & 
& cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,      & 
& cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,          & 
& cplGluFdcSdR,cplGluGluVGL,cplGluGluVGR,cplSdcSdVG,cplSucSuVG,OG2qSL,OG2qSR)
...
& cplcFuFuVGR(3,3),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),cplGluFdcSdL(3,6),            & 
& cplGluFdcSdR(3,6),cplGluGluVGL,cplGluGluVGR,cplSdcSdVG(6,6),cplSucSuVG(6,6)
...
Subroutine CalculateH2q(gt1,gt2,gt3,OnlySM,MCha,MCha2,MChi,MChi2,MFd,MFd2,            & 
& MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,MVWm2,MVZ,              & 
& MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,             & 
& cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,            & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,              & 
& cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,cplcFuFdcHpmL,        & 
...
Complex(dp),Intent(in) :: cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),  & 
& cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),       & 
& cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),               & 
& cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFuHpmL(3,3,2),& 
& cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFdGluSdL(3,6),             & 
& cplcFdGluSdR(3,6),cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),        & 
& cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplChiChihhL(4,4,4),          & 
& cplChiChihhR(4,4,4),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),cplGluFdcSdL(3,6),         & 
& cplGluFdcSdR(3,6),cplhhcHpmVWm(4,2),cplhhcVWmVWm(4),cplhhhhhh(4,4,4),cplhhhhVZ(4,4),   & 
& cplhhHpmcHpm(4,2,2),cplhhHpmcVWm(4,2),cplhhSdcSd(4,6,6),cplhhSucSu(4,6,6),             & 
& cplhhVZVZ(4)
...
End Function C1C2 
End Module FlavorKit_QFV_MSSMCPV 
