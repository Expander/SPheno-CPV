...
Subroutine Gminus2(Ifermion,MCha,MCha2,MChi,MChi2,MFe,MFe2,Mhh,Mhh2,MHpm,             & 
& MHpm2,MSe,MSe2,MSv,MSv2,cplcFeChaSvL,cplcFeChaSvR,cplcChaChaVPL,cplcChaChaVPR,         & 
& cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,           & 
& cplcFeFeVPL,cplcFeFeVPR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,       & 
& cplcFeFvHpmL,cplcFeFvHpmR,cplHpmcHpmVP,cplSecSeVP,a_mu)

Real(dp),Intent(in)  :: MCha(2),MCha2(2),MChi(4),MChi2(4),MFe(3),MFe2(3),Mhh(4),Mhh2(4),MHpm(2),              & 
& MHpm2(2),MSe(6),MSe2(6),MSv(3),MSv2(3)
...
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplHpmcHpmVP(2,2),cplSecSeVP(6,6)
...
Subroutine LeptonEDM(Ifermion,MCha,MCha2,MChi,MChi2,MFe,MFe2,Mhh,Mhh2,MHpm,           & 
& MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcFeChaSvL,cplcFeChaSvR,cplcChaChaVPL,   & 
...
& cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSecSeVP,cplcVWmVPVWm,EDM)

Implicit None
Real(dp),Intent(in)  :: MCha(2),MCha2(2),MChi(4),MChi2(4),MFe(3),MFe2(3),Mhh(4),Mhh2(4),MHpm(2),              & 
& MHpm2(2),MSe(6),MSe2(6),MSv(3),MSv2(3),MVWm,MVWm2,MVZ,MVZ2
...
& cplHpmcHpmVP(2,2),cplSecSeVP(6,6),cplcVWmVPVWm
...
Subroutine DeltaRho(MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,             & 
...
& cplSecSeVZ,cplSecSeVZVZ,cplSecSvcVWm,cplSucSucVWmVWm,cplSucSuVZ,cplSucSuVZVZ,          & 
& cplSvcSvcVWmVWm,cplSvcSvVZ,cplSvcSvVZVZ,rho)
...
Complex(dp),Intent(in)  :: cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),              & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),               & 
...
& cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplChiChacVWmL(4,2),cplChiChacVWmR(4,2),   & 
& cplChiChiVZL(4,4),cplChiChiVZR(4,4),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,             & 
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       & 
& cplcVWmVWmVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcVWmVWm(4),          & 
& cplhhhhcVWmVWm(4,4),cplhhhhVZ(4,4),cplhhhhVZVZ(4,4),cplhhHpmcVWm(4,2),cplhhVZVZ(4),    & 
& cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZVZ(2,2),cplHpmcVWmVP(2),          & 
& cplHpmcVWmVZ(2),cplSdcSdcVWmVWm(6,6),cplSdcSdVZ(6,6),cplSdcSdVZVZ(6,6),cplSdcSucVWm(6,6),& 
...
Call Pi1LoopVZ(0._dp,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,            & 
