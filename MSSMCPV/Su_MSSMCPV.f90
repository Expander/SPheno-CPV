...
=======
! File created at 14:01 on 22.6.2015   
>>>>>>> 7e4986aeb2586d02f5d1a2dd1cc138adf64211e5
! ----------------------------------------------------------------------  
 
 
Module Su3Decays_MSSMCPV 
 
Use Control 
Use CouplingsForDecays_MSSMCPV 
Use ThreeBodyPhaseSpaceS 
 
Contains 
 
Subroutine SuThreeBodyDecay(n_in,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,             & 
...
& me2,M1,M2,M3,vd,vu,gSuSuChiChi,gSucHpmChiFd,gSuhhChiFu,gSuChiGluSu,gSuSdChicCha,       & 
...
Complex(dp) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),  & 
...
Real(dp),Intent(inout) :: gSuSuChiChi(6,6,4,4),gSucHpmChiFd(6,2,4,3),gSuhhChiFu(6,4,4,3),gSuChiGluSu(6,4,1,6),  & 
& gSuSdChicCha(6,6,4,2),gSuFdFucSd(6,3,3,6),gSuFdFvcSe(6,3,3,6),gSuhhFdcCha(6,4,3,2),    & 
& gSuSuFdcFd(6,6,3,3),gSuFdSvcFe(6,3,3,3),gSucHpmChaFu(6,2,2,3),gSuFuFecSe(6,3,3,6),     & 
& gSuFuFucSu(6,3,3,6),gSuFuFvcSv(6,3,3,3),gSucChaFuHpm(6,2,3,2),gSuSdFucFd(6,6,3,3),     & 
& gSuFuSecFe(6,3,6,3),gSuSuFucFu(6,6,3,3),gSuFuSvcFv(6,3,3,3),gSucHpmFdGlu(6,2,3,1),     & 
& gSuhhFuGlu(6,4,3,1),gSuGluGluSu(6,1,1,6),gSuGluSdcCha(6,1,6,2),gSuSdFvcFe(6,6,3,3),    & 
& gSuSuChacCha(6,6,2,2),gSuSuFecFe(6,6,3,3),gSuSuFvcFv(6,6,3,3)

Real(dp) :: gSuSuChiChii(6,4,4),gSucHpmChiFdi(2,4,3),gSuhhChiFui(4,4,3),gSuChiGluSui(4,1,6),      & 
& gSuSdChicChai(6,4,2),gSuFdFucSdi(3,3,6),gSuFdFvcSei(3,3,6),gSuhhFdcChai(4,3,2),        & 
& gSuSuFdcFdi(6,3,3),gSuFdSvcFei(3,3,3),gSucHpmChaFui(2,2,3),gSuFuFecSei(3,3,6),         & 
& gSuFuFucSui(3,3,6),gSuFuFvcSvi(3,3,3),gSucChaFuHpmi(2,3,2),gSuSdFucFdi(6,3,3),         & 
& gSuFuSecFei(3,6,3),gSuSuFucFui(6,3,3),gSuFuSvcFvi(3,3,3),gSucHpmFdGlui(2,3,1),         & 
& gSuhhFuGlui(4,3,1),gSuGluGluSui(1,1,6),gSuGluSdcChai(1,6,2),gSuSdFvcFei(6,3,3),        & 
& gSuSuChacChai(6,2,2),gSuSuFecFei(6,3,3),gSuSuFvcFvi(6,3,3)
...
Call CouplingsFor_Su_decays_3B(MSu(i_run),i_run,MCha,MCha2,MChi,MChi2,MFd,            & 
...
& ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,g1,g2,g3,Yd,Ye,Yu,Mu,Td,Te,Tu,Bmu,mq2,ml2,mHd2,           & 
& mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChacFuSdL,cplcChacFuSdR,cplcChaChahhL,             & 
...
& cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,             & 
...
& cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFuhhL,cplcFuFuhhR,         & 
...
& cplChiChacHpmL,cplChiChacHpmR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,     & 
...
gSuSuChiChii = 0._dp 
Call SuToSuChiChi(i_run,MSu,MChi,MVZ,Mhh,MFu,cplhhSucSu,cplSucSuVZ,cplcFuChiSuL,      & 
& cplcFuChiSuR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,         & 
& cplChiFucSuR,deltaM,epsI,check,gSuSuChiChii)
...
gSuSuFdcFdi = 0._dp 
Call SuToSuFdcFd(i_run,MSu,MFd,MVZ,Mhh,MCha,cplhhSucSu,cplSucSuVZ,cplcChaFdcSuL,      & 
& cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZR,deltaM,epsI,check,gSuSuFdcFdi)
...
gSuSuFucFui = 0._dp 
Call SuToSuFucFu(i_run,MSu,MFu,MVZ,Mhh,MChi,MGlu,cplhhSucSu,cplSucSuVZ,               & 
...
gSuSuChacChai = 0._dp 
Call SuToSuChacCha(i_run,MSu,MCha,MVZ,Mhh,MFd,cplhhSucSu,cplSucSuVZ,cplcChaChahhL,    & 
& cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,    & 
& cplcFdChaSuR,deltaM,epsI,check,gSuSuChacChai)

gSuSuChacCha(i_run,:,:,:) = gSuSuChacChai 
gT(i_run) = gT(i_run) + Sum(gSuSuChacChai) 
 
gSuSuFecFei = 0._dp 
Call SuToSuFecFe(i_run,MSu,MFe,MVZ,Mhh,cplhhSucSu,cplSucSuVZ,cplcFeFehhL,             & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,deltaM,epsI,check,gSuSuFecFei)
...
Subroutine SuToSuChiChi(iIN,MSu,MChi,MVZ,Mhh,MFu,cplhhSucSu,cplSucSuVZ,               & 
& cplcFuChiSuL,cplcFuChiSuR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
& cplChiFucSuL,cplChiFucSuR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSu(6),MChi(4),MVZ,Mhh(4),MFu(3)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplSucSuVZ(6,6),cplcFuChiSuL(3,4,6),cplcFuChiSuR(3,4,6),            & 
...
Real(dp),Intent(in) :: Mhh(4),MChi(4),MFu(3),MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplChiChihhL(4,4,4),          & 
& cplChiChihhR(4,4,4),cplChiFucSuL(4,3,6),cplChiFucSuR(4,3,6)
...
Real(dp),Intent(in) :: Mhh(4),MFd(3),MCha(2),MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaFdcSuL(2,3,6),     & 
& cplcChaFdcSuR(2,3,6),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4)
...
Isum = 121 
Allocate( gSum(4,3,2, Isum) ) 
Allocate( Contribution(4,3,2, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Subroutine SuToSuFdcFd(iIN,MSu,MFd,MVZ,Mhh,MCha,cplhhSucSu,cplSucSuVZ,cplcChaFdcSuL,  & 
& cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSu(6),MFd(3),MVZ,Mhh(4),MCha(2)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplSucSuVZ(6,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),          & 
...
Subroutine SuToSuFucFu(iIN,MSu,MFu,MVZ,Mhh,MChi,MGlu,cplhhSucSu,cplSucSuVZ,           & 
& cplcFuChiSuL,cplcFuChiSuR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,             & 
& cplcFuGluSuL,cplcFuGluSuR,cplChiFucSuL,cplChiFucSuR,cplGluFucSuL,cplGluFucSuR,         & 
& deltaM,epsI,check,g,WriteContributions)
...
Real(dp),Intent(in) :: MSu(6),MFu(3),MVZ,Mhh(4),MChi(4),MGlu

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplSucSuVZ(6,6),cplcFuChiSuL(3,4,6),cplcFuChiSuR(3,4,6),            & 
& cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChiFucSuL(4,3,6),cplChiFucSuR(4,3,6),           & 
& cplGluFucSuL(3,6),cplGluFucSuR(3,6)
...
Real(dp),Intent(in) :: Mhh(4),MFu(3),MGlu,MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplGluFucSuL(3,6),            & 
& cplGluFucSuR(3,6)
...
Isum = 81 
Allocate( gSum(4,3,1, Isum) ) 
Allocate( Contribution(4,3,1, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Subroutine SuToSuChacCha(iIN,MSu,MCha,MVZ,Mhh,MFd,cplhhSucSu,cplSucSuVZ,              & 
...
Real(dp),Intent(in) :: MSu(6),MCha(2),MVZ,Mhh(4),MFd(3)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplSucSuVZ(6,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),          & 
& cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),       & 
& cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6)
...
Subroutine SuToSuFecFe(iIN,MSu,MFe,MVZ,Mhh,cplhhSucSu,cplSucSuVZ,cplcFeFehhL,         & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSu(6),MFe(3),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSucSu(4,6,6),cplSucSuVZ(6,6),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),              & 
