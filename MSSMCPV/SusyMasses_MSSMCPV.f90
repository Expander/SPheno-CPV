...
Subroutine TreeMasses(MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,               & 
...
& me2,M1,M2,M3,GenerationMixing,kont)
...
kontSave = kont 
Call CalculateMhh(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,TW,ZH,Mhh,Mhh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHpm(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,ZP,MHpm,MHpm2,kont)

kont = kontSave 
Call CalculateMChi(g1,g2,Mu,M1,M2,eta,vd,vu,ZN,MChi,kont)

MChi2 = MChi**2 
Call CalculateMCha(g2,Mu,M2,eta,vd,vu,UM,UP,MCha,kont)
...
Subroutine TreeMassesEffPot(MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,              & 
...
& mu2,me2,M1,M2,M3,GenerationMixing,kont)
...
MGlu = Abs(MGlu) 
MGlu2 = MGlu**2 
Call CalculateMSdEffPot(g1,g2,Mu,Yd,Td,mq2,md2,eta,vd,vu,ZD,MSd,MSd2,kont)

Call CalculateMSuEffPot(g1,g2,Mu,Yu,Tu,mq2,mu2,eta,vd,vu,ZU,MSu,MSu2,kont)

Call CalculateMSeEffPot(g1,g2,Mu,Ye,Te,ml2,me2,eta,vd,vu,ZE,MSe,MSe2,kont)

Call CalculateMSvEffPot(g1,g2,ml2,vd,vu,ZV,MSv,MSv2,kont)

kontSave = kont 
Call CalculateMhhEffPot(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,TW,ZH,Mhh,Mhh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHpmEffPot(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,ZP,MHpm,MHpm2,kont)

kont = kontSave 
Call CalculateMChiEffPot(g1,g2,Mu,M1,M2,eta,vd,vu,ZN,MChi,kont)

MChi2 = MChi**2 
Call CalculateMChaEffPot(g2,Mu,M2,eta,vd,vu,UM,UP,MCha,kont)
...
MFd2 = MFd**2 
Call CalculateMFuEffPot(Yu,eta,vu,ZUL,ZUR,MFu,kont)
...
Subroutine CalculateMSd(g1,g2,Mu,Yd,Td,mq2,md2,eta,vd,vu,ZD,MSd,MSd2,kont)
...
End Do 
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(1,1)))/sqrt(2._dp))
mat(1,4) = mat(1,4)+(vd*Conjg(Td(1,1)))/sqrt(2._dp)
mat(1,5) = 0._dp 
mat(1,5) = mat(1,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(2,1)))/sqrt(2._dp))
mat(1,5) = mat(1,5)+(vd*Conjg(Td(2,1)))/sqrt(2._dp)
mat(1,6) = 0._dp 
mat(1,6) = mat(1,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(3,1)))/sqrt(2._dp))
...
End Do 
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(1,2)))/sqrt(2._dp))
mat(2,4) = mat(2,4)+(vd*Conjg(Td(1,2)))/sqrt(2._dp)
mat(2,5) = 0._dp 
mat(2,5) = mat(2,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(2,2)))/sqrt(2._dp))
mat(2,5) = mat(2,5)+(vd*Conjg(Td(2,2)))/sqrt(2._dp)
mat(2,6) = 0._dp 
mat(2,6) = mat(2,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(3,2)))/sqrt(2._dp))
...
End Do 
mat(3,4) = 0._dp 
mat(3,4) = mat(3,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(1,3)))/sqrt(2._dp))
mat(3,4) = mat(3,4)+(vd*Conjg(Td(1,3)))/sqrt(2._dp)
mat(3,5) = 0._dp 
mat(3,5) = mat(3,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(2,3)))/sqrt(2._dp))
mat(3,5) = mat(3,5)+(vd*Conjg(Td(2,3)))/sqrt(2._dp)
mat(3,6) = 0._dp 
mat(3,6) = mat(3,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(3,3)))/sqrt(2._dp))
...
Subroutine CalculateMSu(g1,g2,Mu,Yu,Tu,mq2,mu2,eta,vd,vu,ZU,MSu,MSu2,kont)
...
mat(1,4) = mat(1,4)+(vu*Conjg(Tu(1,1)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(1,5) = 0._dp 
mat(1,5) = mat(1,5)-((vd*Mu*Conjg(Yu(2,1)))/sqrt(2._dp))
mat(1,5) = mat(1,5)+(vu*Conjg(Tu(2,1)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(1,6) = 0._dp 
mat(1,6) = mat(1,6)-((vd*Mu*Conjg(Yu(3,1)))/sqrt(2._dp))
mat(1,6) = mat(1,6)+(vu*Conjg(Tu(3,1)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)-(g1**2*vd**2)/24._dp
mat(2,2) = mat(2,2)+(g2**2*vd**2)/8._dp
mat(2,2) = mat(2,2)+(g1**2*vu**2)/24._dp
...
mat(2,4) = mat(2,4)+(vu*Conjg(Tu(1,2)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(2,5) = 0._dp 
mat(2,5) = mat(2,5)-((vd*Mu*Conjg(Yu(2,2)))/sqrt(2._dp))
mat(2,5) = mat(2,5)+(vu*Conjg(Tu(2,2)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(2,6) = 0._dp 
mat(2,6) = mat(2,6)-((vd*Mu*Conjg(Yu(3,2)))/sqrt(2._dp))
mat(2,6) = mat(2,6)+(vu*Conjg(Tu(3,2)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)-(g1**2*vd**2)/24._dp
mat(3,3) = mat(3,3)+(g2**2*vd**2)/8._dp
mat(3,3) = mat(3,3)+(g1**2*vu**2)/24._dp
...
mat(3,4) = mat(3,4)+(vu*Conjg(Tu(1,3)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(3,5) = 0._dp 
mat(3,5) = mat(3,5)-((vd*Mu*Conjg(Yu(2,3)))/sqrt(2._dp))
mat(3,5) = mat(3,5)+(vu*Conjg(Tu(2,3)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(3,6) = 0._dp 
mat(3,6) = mat(3,6)-((vd*Mu*Conjg(Yu(3,3)))/sqrt(2._dp))
mat(3,6) = mat(3,6)+(vu*Conjg(Tu(3,3)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(4,4) = 0._dp 
...
Subroutine CalculateMSe(g1,g2,Mu,Ye,Te,ml2,me2,eta,vd,vu,ZE,MSe,MSe2,kont)
...
End Do 
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(1,1)))/sqrt(2._dp))
mat(1,4) = mat(1,4)+(vd*Conjg(Te(1,1)))/sqrt(2._dp)
mat(1,5) = 0._dp 
mat(1,5) = mat(1,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(2,1)))/sqrt(2._dp))
mat(1,5) = mat(1,5)+(vd*Conjg(Te(2,1)))/sqrt(2._dp)
mat(1,6) = 0._dp 
mat(1,6) = mat(1,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(3,1)))/sqrt(2._dp))
...
End Do 
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(1,2)))/sqrt(2._dp))
mat(2,4) = mat(2,4)+(vd*Conjg(Te(1,2)))/sqrt(2._dp)
mat(2,5) = 0._dp 
mat(2,5) = mat(2,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(2,2)))/sqrt(2._dp))
mat(2,5) = mat(2,5)+(vd*Conjg(Te(2,2)))/sqrt(2._dp)
mat(2,6) = 0._dp 
mat(2,6) = mat(2,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(3,2)))/sqrt(2._dp))
...
End Do 
mat(3,4) = 0._dp 
mat(3,4) = mat(3,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(1,3)))/sqrt(2._dp))
mat(3,4) = mat(3,4)+(vd*Conjg(Te(1,3)))/sqrt(2._dp)
mat(3,5) = 0._dp 
mat(3,5) = mat(3,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(2,3)))/sqrt(2._dp))
mat(3,5) = mat(3,5)+(vd*Conjg(Te(2,3)))/sqrt(2._dp)
mat(3,6) = 0._dp 
mat(3,6) = mat(3,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(3,3)))/sqrt(2._dp))
...
Subroutine CalculateMhh(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,TW,ZH,Mhh,Mhh2,kont)
...
mat(1,2) = mat(1,2)-(exp((0._dp,1._dp)*eta)*Bmu)/2._dp
mat(1,2) = mat(1,2)-Conjg(Bmu)/(2._dp*exp((0._dp,1._dp)*eta))
mat(1,3) = 0._dp 
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)-1._dp/2._dp*(0.,1._dp)*exp((0._dp,1._dp)*eta)*Bmu
mat(1,4) = mat(1,4)+(1._dp/2._dp*(0.,1._dp)*Conjg(Bmu))/exp((0._dp,1._dp)*eta)
mat(2,2) = 0._dp 
...
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)-1._dp/2._dp*(0.,1._dp)*exp((0._dp,1._dp)*eta)*Bmu
mat(2,3) = mat(2,3)+(1._dp/2._dp*(0.,1._dp)*Conjg(Bmu))/exp((0._dp,1._dp)*eta)
mat(2,4) = 0._dp 
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+mHd2
mat(3,3) = mat(3,3)+(g1**2*vd**2)/8._dp
mat(3,3) = mat(3,3)+(g2**2*vd**2)/8._dp
mat(3,3) = mat(3,3)-(g1**2*vu**2)/8._dp
mat(3,3) = mat(3,3)-(g2**2*vu**2)/8._dp
mat(3,3) = mat(3,3)+Mu*Conjg(Mu)
mat(3,3) = mat(3,3)+(g2**2*vd**2*Cos(TW)**2*RXiZ)/4._dp
mat(3,3) = mat(3,3)+(g1*g2*vd**2*Cos(TW)*RXiZ*Sin(TW))/2._dp
mat(3,3) = mat(3,3)+(g1**2*vd**2*RXiZ*Sin(TW)**2)/4._dp
mat(3,4) = 0._dp 
mat(3,4) = mat(3,4)+(exp((0._dp,1._dp)*eta)*Bmu)/2._dp
mat(3,4) = mat(3,4)+Conjg(Bmu)/(2._dp*exp((0._dp,1._dp)*eta))
mat(3,4) = mat(3,4)-(g2**2*vd*vu*Cos(TW)**2*RXiZ)/4._dp
mat(3,4) = mat(3,4)-(g1*g2*vd*vu*Cos(TW)*RXiZ*Sin(TW))/2._dp
mat(3,4) = mat(3,4)-(g1**2*vd*vu*RXiZ*Sin(TW)**2)/4._dp
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)+mHu2
...
mat(4,4) = mat(4,4)+Mu*Conjg(Mu)
mat(4,4) = mat(4,4)+(g2**2*vu**2*Cos(TW)**2*RXiZ)/4._dp
mat(4,4) = mat(4,4)+(g1*g2*vu**2*Cos(TW)*RXiZ*Sin(TW))/2._dp
mat(4,4) = mat(4,4)+(g1**2*vu**2*RXiZ*Sin(TW)**2)/4._dp
...
Subroutine CalculateMHpm(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,ZP,MHpm,MHpm2,kont)
...
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(g2**2*vd*vu)/4._dp
mat(1,2) = mat(1,2)+Conjg(Bmu)/exp((0._dp,1._dp)*eta)
...
Subroutine CalculateMChi(g1,g2,Mu,M1,M2,eta,vd,vu,ZN,MChi,kont)
...
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)+(g1*vu)/(2._dp*exp((0._dp,1._dp)*eta))
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+M2
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(g2*vd)/2._dp
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-(g2*vu)/(2._dp*exp((0._dp,1._dp)*eta))
mat(3,3) = 0._dp 
mat(3,4) = 0._dp 
...
Subroutine CalculateMCha(g2,Mu,M2,eta,vd,vu,UM,UP,MCha,kont)
...
mat(1,1) = mat(1,1)+M2
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(g2*vu)/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat(2,1) = 0._dp 
...
Subroutine CalculateMFu(Yu,eta,vu,ZUL,ZUR,MFu,kont)
...
ZUR = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(exp((0._dp,1._dp)*eta)*vu*Yu(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(exp((0._dp,1._dp)*eta)*vu*Yu(2,1))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(exp((0._dp,1._dp)*eta)*vu*Yu(3,1))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(exp((0._dp,1._dp)*eta)*vu*Yu(1,2))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(exp((0._dp,1._dp)*eta)*vu*Yu(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(exp((0._dp,1._dp)*eta)*vu*Yu(3,2))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(exp((0._dp,1._dp)*eta)*vu*Yu(1,3))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(exp((0._dp,1._dp)*eta)*vu*Yu(2,3))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(exp((0._dp,1._dp)*eta)*vu*Yu(3,3))/sqrt(2._dp)
...
Subroutine CalculateMSdEffPot(g1,g2,Mu,Yd,Td,mq2,md2,eta,vd,vu,ZD,MSd,MSd2,kont)
...
Subroutine CalculateMSuEffPot(g1,g2,Mu,Yu,Tu,mq2,mu2,eta,vd,vu,ZU,MSu,MSu2,kont)
...
Subroutine CalculateMSeEffPot(g1,g2,Mu,Ye,Te,ml2,me2,eta,vd,vu,ZE,MSe,MSe2,kont)
...
Subroutine CalculateMhhEffPot(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,TW,ZH,Mhh,             & 
& Mhh2,kont)
...
Subroutine CalculateMHpmEffPot(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,ZP,MHpm,              & 
& MHpm2,kont)
...
Subroutine CalculateMChiEffPot(g1,g2,Mu,M1,M2,eta,vd,vu,ZN,MChi,kont)
...
Subroutine CalculateMChaEffPot(g2,Mu,M2,eta,vd,vu,UM,UP,MCha,kont)
...
Subroutine CalculateMFuEffPot(Yu,eta,vu,ZUL,ZUR,MFu,kont)
...
Subroutine SortGoldstones(MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,           & 
& MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,               & 
& MVWm2,MVZ,MVZ2,pG,TW,UM,UP,v,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,             & 
& ZW,ZZ,kont)
...
Integer :: i1, i2, pos 
Real(dp) :: Mhhtemp(4) 
Complex(dp) :: Zhhtemp(4,4) 
Real(dp) :: MHpmtemp(2) 
Complex(dp) :: ZHpmtemp(2,2) 


pos = MinLoc(Abs(Mhh2-MVZ2),1) 
If (pos.ne.1) Then 
  Mhhtemp = Mhh2 
  Zhhtemp = ZH 
  Mhh2(1) = Mhhtemp(pos) 
