...
Subroutine SeThreeBodyDecay(n_in,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,             & 
...
& me2,M1,M2,M3,vd,vu,gSeSvChaChi,gSeChaFecHpm,gSeSeChacCha,gSeSeChiChi,gSehhChiFe,       & 
...
& gSeSeFdcFd,gSeSeFucFu,gSeSvFdcFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gSeSvChaChi(6,3,2,4),gSeChaFecHpm(6,2,3,2),gSeSeChacCha(6,6,2,2),gSeSeChiChi(6,6,4,4),& 
...
& gSeSeFucFu(6,6,3,3),gSeSvFdcFu(6,3,3,3)

Real(dp) :: gSeSvChaChii(3,2,4),gSeChaFecHpmi(2,3,2),gSeSeChacChai(6,2,2),gSeSeChiChii(6,4,4),    & 
& gSehhChiFei(4,4,3),gSeHpmChiFvi(2,4,3),gSeFeFdcSdi(3,3,6),gSeFeFecSei(3,3,6),          & 
& gSeFeFucSui(3,3,6),gSeFvFecSvi(3,3,3),gSeHpmFecChai(2,3,2),gSeFeSdcFdi(3,6,3),         & 
& gSeSeFecFei(6,3,3),gSeFeSucFui(3,6,3),gSeSvFecFvi(3,3,3),gSehhChaFvi(4,2,3),           & 
& gSeFvFdcSui(3,3,6),gSeFvSdcFui(3,6,3),gSeSeFvcFvi(6,3,3),gSeSeFdcFdi(6,3,3),           & 
& gSeSeFucFui(6,3,3),gSeSvFdcFui(3,3,3)
...
Call CouplingsFor_Se_decays_3B(MSe(i_run),i_run,MCha,MCha2,MChi,MChi2,MFd,            & 
...
& cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeChaSvL,             & 
& cplcFeChaSvR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,            & 
...
gSeSeChacChai = 0._dp 
Call SeToSeChacCha(i_run,MSe,MCha,MVZ,Mhh,cplhhSecSe,cplSecSeVZ,cplcChacFvSeL,        & 
& cplcChacFvSeR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplChaFvcSeL,    & 
& cplChaFvcSeR,deltaM,epsI,check,gSeSeChacChai)

gSeSeChacCha(i_run,:,:,:) = gSeSeChacChai 
gT(i_run) = gT(i_run) + Sum(gSeSeChacChai) 
 
gSeSeChiChii = 0._dp 
Call SeToSeChiChi(i_run,MSe,MChi,MVZ,Mhh,MFe,cplhhSecSe,cplSecSeVZ,cplcFeChiSeL,      & 
& cplcFeChiSeR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFecSeL,         & 
& cplChiFecSeR,deltaM,epsI,check,gSeSeChiChii)
...
gSeSeFecFei = 0._dp 
Call SeToSeFecFe(i_run,MSe,MFe,MVZ,Mhh,MChi,cplhhSecSe,cplSecSeVZ,cplcFeChiSeL,       & 
& cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplChiFecSeL,             & 
& cplChiFecSeR,deltaM,epsI,check,gSeSeFecFei)
...
gSeSeFdcFdi = 0._dp 
Call SeToSeFdcFd(i_run,MSe,MFd,MVZ,Mhh,cplhhSecSe,cplSecSeVZ,cplcFdFdhhL,             & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,deltaM,epsI,check,gSeSeFdcFdi)

gSeSeFdcFd(i_run,:,:,:) = gSeSeFdcFdi 
gT(i_run) = gT(i_run) + Sum(gSeSeFdcFdi) 
 
gSeSeFucFui = 0._dp 
Call SeToSeFucFu(i_run,MSe,MFu,MVZ,Mhh,cplhhSecSe,cplSecSeVZ,cplcFuFuhhL,             & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,deltaM,epsI,check,gSeSeFucFui)
...
Subroutine SeToSeChacCha(iIN,MSe,MCha,MVZ,Mhh,cplhhSecSe,cplSecSeVZ,cplcChacFvSeL,    & 
& cplcChacFvSeR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplChaFvcSeL,    & 
& cplChaFvcSeR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSe(6),MCha(2),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),          & 
& cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),       & 
...
Subroutine SeToSeChiChi(iIN,MSe,MChi,MVZ,Mhh,MFe,cplhhSecSe,cplSecSeVZ,               & 
& cplcFeChiSeL,cplcFeChiSeR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
& cplChiFecSeL,cplChiFecSeR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSe(6),MChi(4),MVZ,Mhh(4),MFe(3)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplcFeChiSeL(3,4,6),cplcFeChiSeR(3,4,6),            & 
...
Real(dp),Intent(in) :: Mhh(4),MChi(4),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),cplChiChihhL(4,4,4),          & 
& cplChiChihhR(4,4,4),cplChiFecSeL(4,3,6),cplChiFecSeR(4,3,6)
...
Subroutine SeToSeFecFe(iIN,MSe,MFe,MVZ,Mhh,MChi,cplhhSecSe,cplSecSeVZ,cplcFeChiSeL,   & 
& cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplChiFecSeL,             & 
& cplChiFecSeR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSe(6),MFe(3),MVZ,Mhh(4),MChi(4)
...
Real(dp),Intent(in) :: Mhh(4),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplChaFvcSeL(2,3,6),      & 
& cplChaFvcSeR(2,3,6)
...
Subroutine SeToSeFdcFd(iIN,MSe,MFd,MVZ,Mhh,cplhhSecSe,cplSecSeVZ,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSe(6),MFd(3),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),              & 
...
Subroutine SeToSeFucFu(iIN,MSe,MFu,MVZ,Mhh,cplhhSecSe,cplSecSeVZ,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSe(6),MFu(3),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),              & 
