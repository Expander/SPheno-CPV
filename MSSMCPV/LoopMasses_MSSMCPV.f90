...
! ------------------------------------------------------------------------------  
! File created at 22:38 on 17.6.2015   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_MSSMCPV 
 
Use Control 
Use Couplings_MSSMCPV 
Use LoopFunctions 
Use Mathematics 
Use MathematicsQP 
...
Use Tadpoles_MSSMCPV 
 Use EffectivePotential_MSSMCPV 
 Use Pole2L_MSSMCPV 
...
Subroutine OneLoopMasses(MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
...
Complex(dp) :: cplcChaChaUhhL(2,2,4),cplcChaChaUhhR(2,2,4),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),    & 
& cplcChacUFuSdL(2,3,6),cplcChacUFuSdR(2,3,6),cplcChaFdcUSuL(2,3,6),cplcChaFdcUSuR(2,3,6),& 
& cplcChaFecUSvL(2,3,3),cplcChaFecUSvR(2,3,3),cplcFdFdUhhL(3,3,4),cplcFdFdUhhR(3,3,4),   & 
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeUhhL(3,3,4),cplcFeFeUhhR(3,3,4),             & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFdcUHpmL(3,3,2),cplcFuFdcUHpmR(3,3,2),         & 
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuUhhL(3,3,4),cplcFuFuUhhR(3,3,4),         & 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFvFecUHpmL(3,3,2),cplcFvFecUHpmR(3,3,2),         & 
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),               & 
& cplcgAgWmcVWm,cplcgWmgWmUhh(4),cplcgWmgWmVZ,cplcgWmgZUHpm(2),cplcgWpCgAcVWm,           & 
& cplcgWpCgWpCUhh(4),cplcgWpCgWpCVZ,cplcgWpCgZcUHpm(2),cplcgWpCgZcVWm,cplcgZgWmcUHpm(2), & 
& cplcgZgWmcVWm,cplcgZgWpCUHpm(2),cplcgZgZUhh(4),cplChaFucUSdL(2,3,6),cplChaFucUSdR(2,3,6),& 
& cplChaFvcUSeL(2,3,6),cplChaFvcUSeR(2,3,6),cplChiChacUHpmL(4,2,2),cplChiChacUHpmR(4,2,2),& 
& cplChiChacVWmL(4,2),cplChiChacVWmR(4,2),cplChiChiUhhL(4,4,4),cplChiChiUhhR(4,4,4),     & 
& cplChiChiVZL(4,4),cplChiChiVZR(4,4),cplChiFdcUSdL(4,3,6),cplChiFdcUSdR(4,3,6),         & 
& cplChiFecUSeL(4,3,6),cplChiFecUSeR(4,3,6),cplChiFucUSuL(4,3,6),cplChiFucUSuR(4,3,6),   & 
& cplChiFvcUSvL(4,3,3),cplChiFvcUSvR(4,3,3),cplcUChacFuSdL(2,3,6),cplcUChacFuSdR(2,3,6), & 
& cplcUChacFvSeL(2,3,6),cplcUChacFvSeR(2,3,6),cplcUChaChahhL(2,2,4),cplcUChaChahhR(2,2,4),& 
...
& cplcUFeChiSeL(3,4,6),cplcUFeChiSeR(3,4,6),cplcUFeFehhL(3,3,4),cplcUFeFehhR(3,3,4),     & 
...
& cplcUHpmVPVWm(2),cplcUHpmVWmVZ(2),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,               & 
...
Complex(dp) :: cplhhcUHpmVWm(4,2),cplhhcVWmVWm(4),cplhhhhcVWmVWm(4,4),cplhhhhUHpmcUHpm(4,4,2,2),      & 
& cplhhhhUSdcUSd(4,4,6,6),cplhhhhUSecUSe(4,4,6,6),cplhhhhUSucUSu(4,4,6,6),               & 
& cplhhhhUSvcUSv(4,4,3,3),cplhhhhVZ(4,4),cplhhhhVZVZ(4,4),cplhhHpmcUHpm(4,2,2),          & 
& cplhhHpmcVWm(4,2),cplhhSdcUSd(4,6,6),cplhhSecUSe(4,6,6),cplhhSucUSu(4,6,6),            & 
& cplhhSvcUSv(4,3,3),cplhhVZVZ(4),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVZ(2,2),              & 
...
& cplSvcUSvVZ(3,3),cplUChiChacHpmL(4,2,2),cplUChiChacHpmR(4,2,2),cplUChiChacVWmL(4,2),   & 
& cplUChiChacVWmR(4,2),cplUChiChihhL(4,4,4),cplUChiChihhR(4,4,4),cplUChiChiVZL(4,4),     & 
...
& cplUChiFvcSvR(4,3,3),cplUhhcVWmVWm(4),cplUhhhhhh(4,4,4),cplUhhhhVZ(4,4),               & 
& cplUhhHpmcHpm(4,2,2),cplUhhHpmcVWm(4,2),cplUhhSdcSd(4,6,6),cplUhhSecSe(4,6,6),         & 
& cplUhhSucSu(4,6,6),cplUhhSvcSv(4,3,3),cplUhhUhhcVWmVWm(4,4),cplUhhUhhhhhh(4,4,4,4),    & 
& cplUhhUhhHpmcHpm(4,4,2,2),cplUhhUhhSdcSd(4,4,6,6),cplUhhUhhSecSe(4,4,6,6),             & 
& cplUhhUhhSucSu(4,4,6,6),cplUhhUhhSvcSv(4,4,3,3),cplUhhUhhVZVZ(4,4),cplUhhVZVZ(4),      & 
...
Call CouplingsForLoopMasses(g2,Yd,Yu,UM,UP,ZUL,ZUR,g1,ZN,ZDL,ZDR,g3,pG,               & 
& Mu,Td,eta,vd,vu,ZD,ZH,Tu,ZU,ZP,TW,Ye,ZE,ZEL,ZER,Te,ZV,cplChaFucUSdL,cplChaFucUSdR,     & 
& cplChiFdcUSdL,cplChiFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,cplhhSdcUSd,cplHpmSucUSd,      & 
& cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,cplSucUSdVWm,cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,     & 
& cplUSdSdcUSdcSd,cplUSdSecUSdcSe,cplUSdSucUSdcSu,cplUSdSvcUSdcSv,cplUSdcUSdVGVG,        & 
& cplUSdcUSdVPVP,cplUSdcUSdcVWmVWm,cplUSdcUSdVZVZ,cplChiFucUSuL,cplChiFucUSuR,           & 
& cplcChaFdcUSuL,cplcChaFdcUSuR,cplGluFucUSuL,cplGluFucUSuR,cplhhSucUSu,cplSdcHpmcUSu,   & 
& cplSdcUSucVWm,cplSucUSuVG,cplSucUSuVP,cplSucUSuVZ,cplhhhhUSucUSu,cplHpmUSucHpmcUSu,    & 
& cplSdUSucSdcUSu,cplSeUSucSecUSu,cplUSuSucUSucSu,cplUSuSvcUSucSv,cplUSucUSuVGVG,        & 
& cplUSucUSuVPVP,cplUSucUSucVWmVWm,cplUSucUSuVZVZ,cplChaFvcUSeL,cplChaFvcUSeR,           & 
& cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSecUSeVP,cplSecUSeVZ,          & 
& cplSvcUSeVWm,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,cplUSeSecUSecSe,         & 
...
& cplSecUSvcVWm,cplSvcUSvVZ,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,cplSdUSvcSdcUSv,            & 
...
& cplcgZgZUhh,cplUhhhhhh,cplUhhhhVZ,cplUhhHpmcHpm,cplUhhHpmcVWm,cplUhhSdcSd,             & 
& cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,cplUhhUhhhhhh,            & 
& cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,cplUhhUhhSecSe,cplUhhUhhSucSu,cplUhhUhhSvcSv,          & 
& cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,cplChiChacUHpmL,cplChiChacUHpmR,cplcFuFdcUHpmL,         & 
...
& cplHpmcUHpmVZ,cplSdcUHpmcSu,cplSecUHpmcSv,cplcUHpmVPVWm,cplcUHpmVWmVZ,cplhhhhUHpmcUHpm,& 
& cplUHpmHpmcUHpmcHpm,cplUHpmSdcUHpmcSd,cplUHpmSecUHpmcSe,cplUHpmSucUHpmcSu,             & 
& cplUHpmSvcUHpmcSv,cplUHpmcUHpmVPVP,cplUHpmcUHpmcVWmVWm,cplUHpmcUHpmVZVZ,               & 
...
& cplUChiFecSeR,cplUChiFucSuL,cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,cplcUChaChahhL,  & 
...
& cplcUChacFvSeL,cplcUChacFvSeR,cplcUFeChaSvL,cplcUFeChaSvR,cplcUFeChiSeL,               & 
...
& cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,cplcVWmVWmVZ,cplhhhhVZVZ,cplHpmcHpmVZVZ,   & 
& cplSdcSdVZVZ,cplSecSeVZVZ,cplSucSuVZVZ,cplSvcSvVZVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,   & 
& cplcVWmVWmVZVZ3,cplChiChacVWmL,cplChiChacVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,             & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcgWpCgAcVWm,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgZcVWm, & 
& cplhhHpmcVWm,cplhhcVWmVWm,cplHpmcVWmVP,cplSdcSucVWm,cplSecSvcVWm,cplcVWmVPVWm,         & 
& cplhhhhcVWmVWm,cplHpmcHpmcVWmVWm,cplSdcSdcVWmVWm,cplSecSecVWmVWm,cplSucSucVWmVWm,      & 
& cplSvcSvcVWmVWm,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmcVWmVWmVWm1,    & 
& cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3)

Call OneLoopTadpoleshh(vd,vu,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,             & 
& MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,               & 
& MVZ,MVZ2,cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,cplChiChiUhhR,cplcFdFdUhhL,       & 
...
& cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,Tad1Loop(1:4))
...
Mu2L = Mu
Bmu2L = Bmu
Call OneLoopSd(g1,g2,Mu1L,Yd,Td,mq2,md2,eta,vd,vu,MFu,MFu2,MCha,MCha2,MFd,            & 
& MFd2,MChi,MChi2,MGlu,MGlu2,MSd,MSd2,Mhh,Mhh2,MSu,MSu2,MHpm,MHpm2,MVZ,MVZ2,             & 
& MVWm,MVWm2,MSe,MSe2,MSv,MSv2,cplChaFucUSdL,cplChaFucUSdR,cplChiFdcUSdL,cplChiFdcUSdR,  & 
& cplGluFdcUSdL,cplGluFdcUSdR,cplhhSdcUSd,cplHpmSucUSd,cplSdcUSdVG,cplSdcUSdVP,          & 
& cplSdcUSdVZ,cplSucUSdVWm,cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd,             & 
...
Call OneLoopSu(g1,g2,Mu1L,Yu,Tu,mq2,mu2,eta,vd,vu,MFu,MFu2,MChi,MChi2,MCha,           & 
& MCha2,MFd,MFd2,MGlu,MGlu2,MSu,MSu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MVWm,MVWm2,            & 
& MVZ,MVZ2,MSe,MSe2,MSv,MSv2,cplChiFucUSuL,cplChiFucUSuR,cplcChaFdcUSuL,cplcChaFdcUSuR,  & 
& cplGluFucUSuL,cplGluFucUSuR,cplhhSucUSu,cplSdcHpmcUSu,cplSdcUSucVWm,cplSucUSuVG,       & 
& cplSucUSuVP,cplSucUSuVZ,cplhhhhUSucUSu,cplHpmUSucHpmcUSu,cplSdUSucSdcUSu,              & 
...
Call OneLoopSe(g1,g2,Mu1L,Ye,Te,ml2,me2,eta,vd,vu,MCha,MCha2,MFe,MFe2,MChi,           & 
& MChi2,MSe,MSe2,Mhh,Mhh2,MSv,MSv2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSd,MSd2,              & 
& MSu,MSu2,cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,          & 
& cplHpmSvcUSe,cplSecUSeVP,cplSecUSeVZ,cplSvcUSeVWm,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,    & 
...
& Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplChiFvcUSvL,      & 
& cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,cplhhSvcUSv,cplSecHpmcUSv,cplSecUSvcVWm,   & 
& cplSvcUSvVZ,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,cplSdUSvcSdcUSv,cplSeUSvcSecUSv,          & 
& cplSuUSvcSucUSv,cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,0.1_dp*delta_mass,    & 
& MSv_1L,MSv2_1L,ZV_1L,kont)

Call OneLoophh(g1,g2,Mu2L,Bmu2L,mHd2,mHu2,eta,vd,vu,TW,MCha,MCha2,MChi,               & 
& MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,              & 
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,       & 
...
& cplUhhcVWmVWm,cplUhhVZVZ,cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,cplUhhUhhSecSe, & 
& cplUhhUhhSucSu,cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,0.1_dp*delta_mass,        & 
& Mhh_1L,Mhh2_1L,ZH_1L,kont)

Call OneLoopHpm(g1,g2,Mu1L,Bmu1L,mHd2,mHu2,eta,vd,vu,MChi,MChi2,MCha,MCha2,           & 
& MFu,MFu2,MFd,MFd2,MFe,MFe2,MHpm,MHpm2,Mhh,Mhh2,MVWm,MVWm2,MVZ,MVZ2,MSu,MSu2,           & 
& MSd,MSd2,MSv,MSv2,MSe,MSe2,cplChiChacUHpmL,cplChiChacUHpmR,cplcFuFdcUHpmL,             & 
& cplcFuFdcUHpmR,cplcFvFecUHpmL,cplcFvFecUHpmR,cplcgZgWmcUHpm,cplcgWmgZUHpm,             & 
& cplcgWpCgZcUHpm,cplcgZgWpCUHpm,cplhhHpmcUHpm,cplhhcUHpmVWm,cplHpmcUHpmVP,              & 
& cplHpmcUHpmVZ,cplSdcUHpmcSu,cplSecUHpmcSv,cplcUHpmVPVWm,cplcUHpmVWmVZ,cplhhhhUHpmcUHpm,& 
& cplUHpmHpmcUHpmcHpm,cplUHpmSdcUHpmcSd,cplUHpmSecUHpmcSe,cplUHpmSucUHpmcSu,             & 
...
Call OneLoopChi(g1,g2,Mu1L,M1,M2,eta,vd,vu,MHpm,MHpm2,MCha,MCha2,MVWm,MVWm2,          & 
& Mhh,Mhh2,MChi,MChi2,MVZ,MVZ2,MSd,MSd2,MFd,MFd2,MSe,MSe2,MFe,MFe2,MSu,MSu2,             & 
& MFu,MFu2,MSv,MSv2,cplUChiChacHpmL,cplUChiChacHpmR,cplUChiChacVWmL,cplUChiChacVWmR,     & 
...
& 0.1_dp*delta_mass,MChi_1L,MChi2_1L,ZN_1L,kont)

Call OneLoopCha(g2,Mu1L,M2,eta,vd,vu,Mhh,Mhh2,MCha,MCha2,MVZ,MVZ2,MHpm,               & 
& MHpm2,MChi,MChi2,MVWm,MVWm2,MSu,MSu2,MFd,MFd2,MSv,MSv2,MFe,MFe2,MFu,MFu2,              & 
& MSd,MSd2,MSe,MSe2,cplcUChaChahhL,cplcUChaChahhR,cplcUChaChaVPL,cplcUChaChaVPR,         & 
...
Call SortGoldstones(MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MGlu,            & 
& MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,              & 
& MVZ,MVZ2,pG,TW,UM,UP,v,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,kont)
...
Subroutine OneLoopTadpoleshh(vd,vu,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,           & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,           & 
& MVZ,MVZ2,cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,cplChiChiUhhR,cplcFdFdUhhL,       & 
& cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,        & 
& cplcgWpCgWpCUhh,cplcgZgZUhh,cplUhhhhhh,cplUhhHpmcHpm,cplUhhSdcSd,cplUhhSecSe,          & 
& cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,tadpoles)

Implicit None 
Real(dp), Intent(in) :: MCha(2),MCha2(2),MChi(4),MChi2(4),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),               & 
& MFu2(3),Mhh(4),Mhh2(4),MHpm(2),MHpm2(2),MSd(6),MSd2(6),MSe(6),MSe2(6),MSu(6),          & 
& MSu2(6),MSv(3),MSv2(3),MVWm,MVWm2,MVZ,MVZ2

Complex(dp), Intent(in) :: cplcChaChaUhhL(2,2,4),cplcChaChaUhhR(2,2,4),cplChiChiUhhL(4,4,4),cplChiChiUhhR(4,4,4),& 
...
& cplcgZgZUhh(4),cplUhhhhhh(4,4,4),cplUhhHpmcHpm(4,2,2),cplUhhSdcSd(4,6,6),              & 
& cplUhhSecSe(4,6,6),cplUhhSucSu(4,6,6),cplUhhSvcSv(4,3,3),cplUhhcVWmVWm(4),             & 
& cplUhhVZVZ(4)
...
Subroutine OneLoopSd(g1,g2,Mu,Yd,Td,mq2,md2,eta,vd,vu,MFu,MFu2,MCha,MCha2,            & 
& MFd,MFd2,MChi,MChi2,MGlu,MGlu2,MSd,MSd2,Mhh,Mhh2,MSu,MSu2,MHpm,MHpm2,MVZ,              & 
& MVZ2,MVWm,MVWm2,MSe,MSe2,MSv,MSv2,cplChaFucUSdL,cplChaFucUSdR,cplChiFdcUSdL,           & 
& cplChiFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,cplhhSdcUSd,cplHpmSucUSd,cplSdcUSdVG,        & 
& cplSdcUSdVP,cplSdcUSdVZ,cplSucUSdVWm,cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd, & 
& cplUSdSecUSdcSe,cplUSdSucUSdcSu,cplUSdSvcUSdcSv,cplUSdcUSdVGVG,cplUSdcUSdVPVP,         & 
& cplUSdcUSdcVWmVWm,cplUSdcUSdVZVZ,delta,mass,mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: MFu(3),MFu2(3),MCha(2),MCha2(2),MFd(3),MFd2(3),MChi(4),MChi2(4),MGlu,MGlu2,           & 
& MSd(6),MSd2(6),Mhh(4),Mhh2(4),MSu(6),MSu2(6),MHpm(2),MHpm2(2),MVZ,MVZ2,MVWm,           & 
& MVWm2,MSe(6),MSe2(6),MSv(3),MSv2(3)

Real(dp), Intent(in) :: g1,g2,eta,vd,vu

Complex(dp), Intent(in) :: Mu,Yd(3,3),Td(3,3),mq2(3,3),md2(3,3)

Complex(dp), Intent(in) :: cplChaFucUSdL(2,3,6),cplChaFucUSdR(2,3,6),cplChiFdcUSdL(4,3,6),cplChiFdcUSdR(4,3,6),  & 
& cplGluFdcUSdL(3,6),cplGluFdcUSdR(3,6),cplhhSdcUSd(4,6,6),cplHpmSucUSd(2,6,6),          & 
& cplSdcUSdVG(6,6),cplSdcUSdVP(6,6),cplSdcUSdVZ(6,6),cplSucUSdVWm(6,6),cplhhhhUSdcUSd(4,4,6,6),& 
& cplHpmUSdcHpmcUSd(2,6,2,6),cplUSdSdcUSdcSd(6,6,6,6),cplUSdSecUSdcSe(6,6,6,6),          & 
& cplUSdSucUSdcSu(6,6,6,6),cplUSdSvcUSdcSv(6,3,6,3),cplUSdcUSdVGVG(6,6),cplUSdcUSdVPVP(6,6),& 
...
End Do 
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(1,1)))/sqrt(2._dp))
mat2a(1,4) = mat2a(1,4)+(vd*Conjg(Td(1,1)))/sqrt(2._dp)
mat2a(1,5) = 0._dp 
mat2a(1,5) = mat2a(1,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(2,1)))/sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)+(vd*Conjg(Td(2,1)))/sqrt(2._dp)
mat2a(1,6) = 0._dp 
mat2a(1,6) = mat2a(1,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(3,1)))/sqrt(2._dp))
...
End Do 
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(1,2)))/sqrt(2._dp))
mat2a(2,4) = mat2a(2,4)+(vd*Conjg(Td(1,2)))/sqrt(2._dp)
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(2,2)))/sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)+(vd*Conjg(Td(2,2)))/sqrt(2._dp)
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(3,2)))/sqrt(2._dp))
...
End Do 
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(1,3)))/sqrt(2._dp))
mat2a(3,4) = mat2a(3,4)+(vd*Conjg(Td(1,3)))/sqrt(2._dp)
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(2,3)))/sqrt(2._dp))
mat2a(3,5) = mat2a(3,5)+(vd*Conjg(Td(2,3)))/sqrt(2._dp)
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Yd(3,3)))/sqrt(2._dp))
...
PiSf(i1,:,:) = ZeroC 
p2 = MSd2(i1)
Call Pi1LoopSd(p2,MFu,MFu2,MCha,MCha2,MFd,MFd2,MChi,MChi2,MGlu,MGlu2,MSd,             & 
& MSd2,Mhh,Mhh2,MSu,MSu2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSe,MSe2,MSv,MSv2,               & 
...
Subroutine Pi1LoopSd(p2,MFu,MFu2,MCha,MCha2,MFd,MFd2,MChi,MChi2,MGlu,MGlu2,           & 
& MSd,MSd2,Mhh,Mhh2,MSu,MSu2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSe,MSe2,MSv,MSv2,           & 
& cplChaFucUSdL,cplChaFucUSdR,cplChiFdcUSdL,cplChiFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,   & 
& cplhhSdcUSd,cplHpmSucUSd,cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,cplSucUSdVWm,             & 
& cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd,cplUSdSecUSdcSe,cplUSdSucUSdcSu,      & 
...
Subroutine OneLoopSu(g1,g2,Mu,Yu,Tu,mq2,mu2,eta,vd,vu,MFu,MFu2,MChi,MChi2,            & 
& MCha,MCha2,MFd,MFd2,MGlu,MGlu2,MSu,MSu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MVWm,             & 
& MVWm2,MVZ,MVZ2,MSe,MSe2,MSv,MSv2,cplChiFucUSuL,cplChiFucUSuR,cplcChaFdcUSuL,           & 
& cplcChaFdcUSuR,cplGluFucUSuL,cplGluFucUSuR,cplhhSucUSu,cplSdcHpmcUSu,cplSdcUSucVWm,    & 
& cplSucUSuVG,cplSucUSuVP,cplSucUSuVZ,cplhhhhUSucUSu,cplHpmUSucHpmcUSu,cplSdUSucSdcUSu,  & 
& cplSeUSucSecUSu,cplUSuSucUSucSu,cplUSuSvcUSucSv,cplUSucUSuVGVG,cplUSucUSuVPVP,         & 
& cplUSucUSucVWmVWm,cplUSucUSuVZVZ,delta,mass,mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: MFu(3),MFu2(3),MChi(4),MChi2(4),MCha(2),MCha2(2),MFd(3),MFd2(3),MGlu,MGlu2,           & 
& MSu(6),MSu2(6),Mhh(4),Mhh2(4),MHpm(2),MHpm2(2),MSd(6),MSd2(6),MVWm,MVWm2,              & 
& MVZ,MVZ2,MSe(6),MSe2(6),MSv(3),MSv2(3)

Real(dp), Intent(in) :: g1,g2,eta,vd,vu

Complex(dp), Intent(in) :: Mu,Yu(3,3),Tu(3,3),mq2(3,3),mu2(3,3)

Complex(dp), Intent(in) :: cplChiFucUSuL(4,3,6),cplChiFucUSuR(4,3,6),cplcChaFdcUSuL(2,3,6),cplcChaFdcUSuR(2,3,6),& 
& cplGluFucUSuL(3,6),cplGluFucUSuR(3,6),cplhhSucUSu(4,6,6),cplSdcHpmcUSu(6,2,6),         & 
& cplSdcUSucVWm(6,6),cplSucUSuVG(6,6),cplSucUSuVP(6,6),cplSucUSuVZ(6,6),cplhhhhUSucUSu(4,4,6,6),& 
...
mat2a(1,4) = mat2a(1,4)+(vu*Conjg(Tu(1,1)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(1,5) = 0._dp 
mat2a(1,5) = mat2a(1,5)-((vd*Mu*Conjg(Yu(2,1)))/sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)+(vu*Conjg(Tu(2,1)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(1,6) = 0._dp 
mat2a(1,6) = mat2a(1,6)-((vd*Mu*Conjg(Yu(3,1)))/sqrt(2._dp))
mat2a(1,6) = mat2a(1,6)+(vu*Conjg(Tu(3,1)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)-(g1**2*vd**2)/24._dp
mat2a(2,2) = mat2a(2,2)+(g2**2*vd**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(g1**2*vu**2)/24._dp
...
mat2a(2,4) = mat2a(2,4)+(vu*Conjg(Tu(1,2)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)-((vd*Mu*Conjg(Yu(2,2)))/sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)+(vu*Conjg(Tu(2,2)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)-((vd*Mu*Conjg(Yu(3,2)))/sqrt(2._dp))
mat2a(2,6) = mat2a(2,6)+(vu*Conjg(Tu(3,2)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)-(g1**2*vd**2)/24._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(g1**2*vu**2)/24._dp
...
mat2a(3,4) = mat2a(3,4)+(vu*Conjg(Tu(1,3)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)-((vd*Mu*Conjg(Yu(2,3)))/sqrt(2._dp))
mat2a(3,5) = mat2a(3,5)+(vu*Conjg(Tu(2,3)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-((vd*Mu*Conjg(Yu(3,3)))/sqrt(2._dp))
mat2a(3,6) = mat2a(3,6)+(vu*Conjg(Tu(3,3)))/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat2a(4,4) = 0._dp 
...
PiSf(i1,:,:) = ZeroC 
p2 = MSu2(i1)
Call Pi1LoopSu(p2,MFu,MFu2,MChi,MChi2,MCha,MCha2,MFd,MFd2,MGlu,MGlu2,MSu,             & 
& MSu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MVWm,MVWm2,MVZ,MVZ2,MSe,MSe2,MSv,MSv2,               & 
...
& cplSucUSuVZ,cplhhhhUSucUSu,cplHpmUSucHpmcUSu,cplSdUSucSdcUSu,cplSeUSucSecUSu,          & 
...
Subroutine Pi1LoopSu(p2,MFu,MFu2,MChi,MChi2,MCha,MCha2,MFd,MFd2,MGlu,MGlu2,           & 
& MSu,MSu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MVWm,MVWm2,MVZ,MVZ2,MSe,MSe2,MSv,MSv2,           & 
& cplChiFucUSuL,cplChiFucUSuR,cplcChaFdcUSuL,cplcChaFdcUSuR,cplGluFucUSuL,               & 
& cplGluFucUSuR,cplhhSucUSu,cplSdcHpmcUSu,cplSdcUSucVWm,cplSucUSuVG,cplSucUSuVP,         & 
& cplSucUSuVZ,cplhhhhUSucUSu,cplHpmUSucHpmcUSu,cplSdUSucSdcUSu,cplSeUSucSecUSu,          & 
& cplUSuSucUSucSu,cplUSuSvcUSucSv,cplUSucUSuVGVG,cplUSucUSuVPVP,cplUSucUSucVWmVWm,       & 
...
Subroutine OneLoopSe(g1,g2,Mu,Ye,Te,ml2,me2,eta,vd,vu,MCha,MCha2,MFe,MFe2,            & 
& MChi,MChi2,MSe,MSe2,Mhh,Mhh2,MSv,MSv2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSd,              & 
& MSd2,MSu,MSu2,cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,     & 
& cplHpmSvcUSe,cplSecUSeVP,cplSecUSeVZ,cplSvcUSeVWm,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,    & 
& cplSdUSecSdcUSe,cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,cplUSecUSeVPVP,        & 
& cplUSecUSecVWmVWm,cplUSecUSeVZVZ,delta,mass,mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: MCha(2),MCha2(2),MFe(3),MFe2(3),MChi(4),MChi2(4),MSe(6),MSe2(6),Mhh(4),               & 
& Mhh2(4),MSv(3),MSv2(3),MHpm(2),MHpm2(2),MVZ,MVZ2,MVWm,MVWm2,MSd(6),MSd2(6),            & 
& MSu(6),MSu2(6)
...
Complex(dp), Intent(in) :: cplChaFvcUSeL(2,3,6),cplChaFvcUSeR(2,3,6),cplChiFecUSeL(4,3,6),cplChiFecUSeR(4,3,6),  & 
& cplhhSecUSe(4,6,6),cplHpmSvcUSe(2,3,6),cplSecUSeVP(6,6),cplSecUSeVZ(6,6),              & 
& cplSvcUSeVWm(3,6),cplhhhhUSecUSe(4,4,6,6),cplHpmUSecHpmcUSe(2,6,2,6),cplSdUSecSdcUSe(6,6,6,6),& 
& cplUSeSecUSecSe(6,6,6,6),cplUSeSucUSecSu(6,6,6,6),cplUSeSvcUSecSv(6,3,6,3),            & 
& cplUSecUSeVPVP(6,6),cplUSecUSecVWmVWm(6,6),cplUSecUSeVZVZ(6,6)
...
End Do 
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(1,1)))/sqrt(2._dp))
mat2a(1,4) = mat2a(1,4)+(vd*Conjg(Te(1,1)))/sqrt(2._dp)
mat2a(1,5) = 0._dp 
mat2a(1,5) = mat2a(1,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(2,1)))/sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)+(vd*Conjg(Te(2,1)))/sqrt(2._dp)
mat2a(1,6) = 0._dp 
mat2a(1,6) = mat2a(1,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(3,1)))/sqrt(2._dp))
...
End Do 
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(1,2)))/sqrt(2._dp))
mat2a(2,4) = mat2a(2,4)+(vd*Conjg(Te(1,2)))/sqrt(2._dp)
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(2,2)))/sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)+(vd*Conjg(Te(2,2)))/sqrt(2._dp)
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(3,2)))/sqrt(2._dp))
...
End Do 
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(1,3)))/sqrt(2._dp))
mat2a(3,4) = mat2a(3,4)+(vd*Conjg(Te(1,3)))/sqrt(2._dp)
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(2,3)))/sqrt(2._dp))
mat2a(3,5) = mat2a(3,5)+(vd*Conjg(Te(2,3)))/sqrt(2._dp)
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-((exp((0._dp,1._dp)*eta)*vu*Mu*Conjg(Ye(3,3)))/sqrt(2._dp))
...
PiSf(i1,:,:) = ZeroC 
p2 = MSe2(i1)
Call Pi1LoopSe(p2,MCha,MCha2,MFe,MFe2,MChi,MChi2,MSe,MSe2,Mhh,Mhh2,MSv,               & 
& MSv2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSd,MSd2,MSu,MSu2,cplChaFvcUSeL,cplChaFvcUSeR,     & 
& cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSecUSeVP,cplSecUSeVZ,          & 
& cplSvcUSeVWm,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,cplUSeSecUSecSe,         & 
& cplUSeSucUSecSu,cplUSeSvcUSecSv,cplUSecUSeVPVP,cplUSecUSecVWmVWm,cplUSecUSeVZVZ,       & 
& kont,PiSf(i1,:,:))
...
Subroutine Pi1LoopSe(p2,MCha,MCha2,MFe,MFe2,MChi,MChi2,MSe,MSe2,Mhh,Mhh2,             & 
& MSv,MSv2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSd,MSd2,MSu,MSu2,cplChaFvcUSeL,               & 
& cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSecUSeVP,        & 
& cplSecUSeVZ,cplSvcUSeVWm,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,             & 
...
& MSv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,               & 
& cplChiFvcUSvL,cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,cplhhSvcUSv,cplSecHpmcUSv,   & 
& cplSecUSvcVWm,cplSvcUSvVZ,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,cplSdUSvcSdcUSv,            & 
& cplSeUSvcSecUSv,cplSuUSvcSucUSv,cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,      & 
...
Implicit None 
Real(dp), Intent(in) :: MChi(4),MChi2(4),MCha(2),MCha2(2),MFe(3),MFe2(3),MSv(3),MSv2(3),Mhh(4),               & 
& Mhh2(4),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MVWm,MVWm2,MVZ,MVZ2,MSd(6),MSd2(6),            & 
& MSu(6),MSu2(6)
...
& cplhhSvcUSv(4,3,3),cplSecHpmcUSv(6,2,3),cplSecUSvcVWm(6,3),cplSvcUSvVZ(3,3),           & 
& cplhhhhUSvcUSv(4,4,3,3),cplHpmUSvcHpmcUSv(2,3,2,3),cplSdUSvcSdcUSv(6,3,6,3),           & 
& cplSeUSvcSecUSv(6,3,6,3),cplSuUSvcSucUSv(6,3,6,3),cplUSvSvcUSvcSv(3,3,3,3),            & 
& cplUSvcUSvcVWmVWm(3,3),cplUSvcUSvVZVZ(3,3)
...
& MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplChiFvcUSvL,cplChiFvcUSvR,      & 
...
& cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,kont,PiSf(i1,:,:))
...
& MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplChiFvcUSvL,               & 
& cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,cplhhSvcUSv,cplSecHpmcUSv,cplSecUSvcVWm,   & 
& cplSvcUSvVZ,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,cplSdUSvcSdcUSv,cplSeUSvcSecUSv,          & 
& cplSuUSvcSucUSv,cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,kont,res)
...
Subroutine OneLoophh(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,TW,MCha,MCha2,MChi,             & 
& MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,              & 
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,       & 
& cplChiChiUhhR,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,        & 
& cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,cplcgZgZUhh,cplUhhhhhh,cplUhhhhVZ,          & 
& cplUhhHpmcHpm,cplUhhHpmcVWm,cplUhhSdcSd,cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,           & 
& cplUhhcVWmVWm,cplUhhVZVZ,cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,cplUhhUhhSecSe, & 
& cplUhhUhhSucSu,cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,delta,mass,               & 
& mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: MCha(2),MCha2(2),MChi(4),MChi2(4),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),               & 
& MFu2(3),Mhh(4),Mhh2(4),MVZ,MVZ2,MHpm(2),MHpm2(2),MVWm,MVWm2,MSd(6),MSd2(6),            & 
& MSe(6),MSe2(6),MSu(6),MSu2(6),MSv(3),MSv2(3)

Real(dp), Intent(in) :: g1,g2,mHd2,mHu2,eta,vd,vu,TW
...
mat2a(1,2) = mat2a(1,2)-(exp((0._dp,1._dp)*eta)*Bmu)/2._dp
mat2a(1,2) = mat2a(1,2)-Conjg(Bmu)/(2._dp*exp((0._dp,1._dp)*eta))
mat2a(1,3) = 0._dp 
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(0.,1._dp)*exp((0._dp,1._dp)*eta)*Bmu
mat2a(1,4) = mat2a(1,4)+(1._dp/2._dp*(0.,1._dp)*Conjg(Bmu))/exp((0._dp,1._dp)*eta)
mat2a(2,2) = 0._dp 
...
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(0.,1._dp)*exp((0._dp,1._dp)*eta)*Bmu
mat2a(2,3) = mat2a(2,3)+(1._dp/2._dp*(0.,1._dp)*Conjg(Bmu))/exp((0._dp,1._dp)*eta)
mat2a(2,4) = 0._dp 
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+mHd2
mat2a(3,3) = mat2a(3,3)+(g1**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)-(g1**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)-(g2**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)+Mu*Conjg(Mu)
mat2a(3,3) = mat2a(3,3)+(g2**2*vd**2*Cos(TW)**2*RXiZ)/4._dp
mat2a(3,3) = mat2a(3,3)+(g1*g2*vd**2*Cos(TW)*RXiZ*Sin(TW))/2._dp
mat2a(3,3) = mat2a(3,3)+(g1**2*vd**2*RXiZ*Sin(TW)**2)/4._dp
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)+(exp((0._dp,1._dp)*eta)*Bmu)/2._dp
mat2a(3,4) = mat2a(3,4)+Conjg(Bmu)/(2._dp*exp((0._dp,1._dp)*eta))
mat2a(3,4) = mat2a(3,4)-(g2**2*vd*vu*Cos(TW)**2*RXiZ)/4._dp
mat2a(3,4) = mat2a(3,4)-(g1*g2*vd*vu*Cos(TW)*RXiZ*Sin(TW))/2._dp
mat2a(3,4) = mat2a(3,4)-(g1**2*vd*vu*RXiZ*Sin(TW)**2)/4._dp
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)+mHu2
...
mat2a(4,4) = mat2a(4,4)+Mu*Conjg(Mu)
mat2a(4,4) = mat2a(4,4)+(g2**2*vu**2*Cos(TW)**2*RXiZ)/4._dp
mat2a(4,4) = mat2a(4,4)+(g1*g2*vu**2*Cos(TW)*RXiZ*Sin(TW))/2._dp
mat2a(4,4) = mat2a(4,4)+(g1**2*vu**2*RXiZ*Sin(TW)**2)/4._dp
...
p2 = Mhh2(i1)
If (i1.eq.1) p2 = 0._dp 
Call Pi1Loophh(p2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,               & 
& Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,               & 
& cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,cplChiChiUhhR,cplcFdFdUhhL,cplcFdFdUhhR,   & 
& cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,     & 
& cplcgZgZUhh,cplUhhhhhh,cplUhhhhVZ,cplUhhHpmcHpm,cplUhhHpmcVWm,cplUhhSdcSd,             & 
...
Subroutine Pi1Loophh(p2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,             & 
& Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,           & 
& cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,cplChiChiUhhR,cplcFdFdUhhL,cplcFdFdUhhR,   & 
& cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,     & 
& cplcgZgZUhh,cplUhhhhhh,cplUhhhhVZ,cplUhhHpmcHpm,cplUhhHpmcVWm,cplUhhSdcSd,             & 
& cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,cplUhhUhhhhhh,            & 
...
Subroutine OneLoopHpm(g1,g2,Mu,Bmu,mHd2,mHu2,eta,vd,vu,MChi,MChi2,MCha,               & 
& MCha2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MHpm,MHpm2,Mhh,Mhh2,MVWm,MVWm2,MVZ,MVZ2,              & 
& MSu,MSu2,MSd,MSd2,MSv,MSv2,MSe,MSe2,cplChiChacUHpmL,cplChiChacUHpmR,cplcFuFdcUHpmL,    & 
& cplcFuFdcUHpmR,cplcFvFecUHpmL,cplcFvFecUHpmR,cplcgZgWmcUHpm,cplcgWmgZUHpm,             & 
& cplcgWpCgZcUHpm,cplcgZgWpCUHpm,cplhhHpmcUHpm,cplhhcUHpmVWm,cplHpmcUHpmVP,              & 
& cplHpmcUHpmVZ,cplSdcUHpmcSu,cplSecUHpmcSv,cplcUHpmVPVWm,cplcUHpmVWmVZ,cplhhhhUHpmcUHpm,& 
& cplUHpmHpmcUHpmcHpm,cplUHpmSdcUHpmcSd,cplUHpmSecUHpmcSe,cplUHpmSucUHpmcSu,             & 
...
Implicit None 
Real(dp), Intent(in) :: MChi(4),MChi2(4),MCha(2),MCha2(2),MFu(3),MFu2(3),MFd(3),MFd2(3),MFe(3),               & 
& MFe2(3),MHpm(2),MHpm2(2),Mhh(4),Mhh2(4),MVWm,MVWm2,MVZ,MVZ2,MSu(6),MSu2(6),            & 
& MSd(6),MSd2(6),MSv(3),MSv2(3),MSe(6),MSe2(6)

Real(dp), Intent(in) :: g1,g2,mHd2,mHu2,eta,vd,vu

Complex(dp), Intent(in) :: Mu,Bmu

Complex(dp), Intent(in) :: cplChiChacUHpmL(4,2,2),cplChiChacUHpmR(4,2,2),cplcFuFdcUHpmL(3,3,2),cplcFuFdcUHpmR(3,3,2),& 
& cplcFvFecUHpmL(3,3,2),cplcFvFecUHpmR(3,3,2),cplcgZgWmcUHpm(2),cplcgWmgZUHpm(2),        & 
& cplcgWpCgZcUHpm(2),cplcgZgWpCUHpm(2),cplhhHpmcUHpm(4,2,2),cplhhcUHpmVWm(4,2),          & 
& cplHpmcUHpmVP(2,2),cplHpmcUHpmVZ(2,2),cplSdcUHpmcSu(6,2,6),cplSecUHpmcSv(6,2,3),       & 
& cplcUHpmVPVWm(2),cplcUHpmVWmVZ(2),cplhhhhUHpmcUHpm(4,4,2,2),cplUHpmHpmcUHpmcHpm(2,2,2,2),& 
& cplUHpmSdcUHpmcSd(2,6,2,6),cplUHpmSecUHpmcSe(2,6,2,6),cplUHpmSucUHpmcSu(2,6,2,6),      & 
...
mat2a(1,2) = 0._dp 
mat2a(1,2) = mat2a(1,2)+(g2**2*vd*vu)/4._dp
mat2a(1,2) = mat2a(1,2)+Conjg(Bmu)/exp((0._dp,1._dp)*eta)
...
p2 = MHpm2(i1)
If (i1.eq.1) p2 = 0._dp 
Call Pi1LoopHpm(p2,MChi,MChi2,MCha,MCha2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MHpm,             & 
& MHpm2,Mhh,Mhh2,MVWm,MVWm2,MVZ,MVZ2,MSu,MSu2,MSd,MSd2,MSv,MSv2,MSe,MSe2,cplChiChacUHpmL,& 
...
& cplcUHpmVWmVZ,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,cplUHpmSdcUHpmcSd,cplUHpmSecUHpmcSe,& 
...
Subroutine Pi1LoopHpm(p2,MChi,MChi2,MCha,MCha2,MFu,MFu2,MFd,MFd2,MFe,MFe2,            & 
...
& cplcUHpmVPVWm,cplcUHpmVWmVZ,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,cplUHpmSdcUHpmcSd,    & 
...
Subroutine OneLoopChi(g1,g2,Mu,M1,M2,eta,vd,vu,MHpm,MHpm2,MCha,MCha2,MVWm,            & 
& MVWm2,Mhh,Mhh2,MChi,MChi2,MVZ,MVZ2,MSd,MSd2,MFd,MFd2,MSe,MSe2,MFe,MFe2,MSu,            & 
& MSu2,MFu,MFu2,MSv,MSv2,cplUChiChacHpmL,cplUChiChacHpmR,cplUChiChacVWmL,cplUChiChacVWmR,& 
& cplUChiChihhL,cplUChiChihhR,cplUChiChiVZL,cplUChiChiVZR,cplUChiFdcSdL,cplUChiFdcSdR,   & 
& cplUChiFecSeL,cplUChiFecSeR,cplUChiFucSuL,cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,   & 
& delta,MChi_1L,MChi2_1L,ZN_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MHpm(2),MHpm2(2),MCha(2),MCha2(2),MVWm,MVWm2,Mhh(4),Mhh2(4),MChi(4),MChi2(4),         & 
& MVZ,MVZ2,MSd(6),MSd2(6),MFd(3),MFd2(3),MSe(6),MSe2(6),MFe(3),MFe2(3),MSu(6),           & 
& MSu2(6),MFu(3),MFu2(3),MSv(3),MSv2(3)

Real(dp), Intent(in) :: g1,g2,eta,vd,vu

Complex(dp), Intent(in) :: Mu,M1,M2

Complex(dp), Intent(in) :: cplUChiChacHpmL(4,2,2),cplUChiChacHpmR(4,2,2),cplUChiChacVWmL(4,2),cplUChiChacVWmR(4,2),& 
& cplUChiChihhL(4,4,4),cplUChiChihhR(4,4,4),cplUChiChiVZL(4,4),cplUChiChiVZR(4,4),       & 
...
mat1a(1,4) = 0._dp 
mat1a(1,4) = mat1a(1,4)+(g1*vu)/(2._dp*exp((0._dp,1._dp)*eta))
mat1a(2,1) = 0._dp 
mat1a(2,2) = 0._dp 
...
mat1a(2,4) = 0._dp 
mat1a(2,4) = mat1a(2,4)-(g2*vu)/(2._dp*exp((0._dp,1._dp)*eta))
mat1a(3,1) = 0._dp 
...
mat1a(4,1) = 0._dp 
mat1a(4,1) = mat1a(4,1)+(g1*vu)/(2._dp*exp((0._dp,1._dp)*eta))
mat1a(4,2) = 0._dp 
mat1a(4,2) = mat1a(4,2)-(g2*vu)/(2._dp*exp((0._dp,1._dp)*eta))
mat1a(4,3) = 0._dp 
...
sigS=0._dp 
p2 = MChi2(il)
Call Sigma1LoopChi(p2,MHpm,MHpm2,MCha,MCha2,MVWm,MVWm2,Mhh,Mhh2,MChi,MChi2,           & 
& MVZ,MVZ2,MSd,MSd2,MFd,MFd2,MSe,MSe2,MFe,MFe2,MSu,MSu2,MFu,MFu2,MSv,MSv2,               & 
& cplUChiChacHpmL,cplUChiChacHpmR,cplUChiChacVWmL,cplUChiChacVWmR,cplUChiChihhL,         & 
& cplUChiChihhR,cplUChiChiVZL,cplUChiChiVZR,cplUChiFdcSdL,cplUChiFdcSdR,cplUChiFecSeL,   & 
& cplUChiFecSeR,cplUChiFucSuL,cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,sigL,            & 
& sigR,sigS)
...
Subroutine Sigma1LoopChi(p2,MHpm,MHpm2,MCha,MCha2,MVWm,MVWm2,Mhh,Mhh2,MChi,           & 
& MChi2,MVZ,MVZ2,MSd,MSd2,MFd,MFd2,MSe,MSe2,MFe,MFe2,MSu,MSu2,MFu,MFu2,MSv,              & 
& MSv2,cplUChiChacHpmL,cplUChiChacHpmR,cplUChiChacVWmL,cplUChiChacVWmR,cplUChiChihhL,    & 
& cplUChiChihhR,cplUChiChiVZL,cplUChiChiVZR,cplUChiFdcSdL,cplUChiFdcSdR,cplUChiFecSeL,   & 
& cplUChiFecSeR,cplUChiFucSuL,cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,sigL,            & 
& sigR,sigS)
...
Subroutine OneLoopCha(g2,Mu,M2,eta,vd,vu,Mhh,Mhh2,MCha,MCha2,MVZ,MVZ2,MHpm,           & 
& MHpm2,MChi,MChi2,MVWm,MVWm2,MSu,MSu2,MFd,MFd2,MSv,MSv2,MFe,MFe2,MFu,MFu2,              & 
& MSd,MSd2,MSe,MSe2,cplcUChaChahhL,cplcUChaChahhR,cplcUChaChaVPL,cplcUChaChaVPR,         & 
& cplcUChaChaVZL,cplcUChaChaVZR,cplcUChaChiHpmL,cplcUChaChiHpmR,cplcUChaChiVWmL,         & 
& cplcUChaChiVWmR,cplcUChaFdcSuL,cplcUChaFdcSuR,cplcUChaFecSvL,cplcUChaFecSvR,           & 
& cplcUChacFuSdL,cplcUChacFuSdR,cplcUChacFvSeL,cplcUChacFvSeR,delta,MCha_1L,             & 
& MCha2_1L,UM_1L,UP_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: Mhh(4),Mhh2(4),MCha(2),MCha2(2),MVZ,MVZ2,MHpm(2),MHpm2(2),MChi(4),MChi2(4),           & 
& MVWm,MVWm2,MSu(6),MSu2(6),MFd(3),MFd2(3),MSv(3),MSv2(3),MFe(3),MFe2(3),MFu(3),         & 
& MFu2(3),MSd(6),MSd2(6),MSe(6),MSe2(6)

Real(dp), Intent(in) :: g2,eta,vd,vu

Complex(dp), Intent(in) :: Mu,M2

Complex(dp), Intent(in) :: cplcUChaChahhL(2,2,4),cplcUChaChahhR(2,2,4),cplcUChaChaVPL(2,2),cplcUChaChaVPR(2,2),  & 
...
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(g2*vu)/(sqrt(2._dp)*exp((0._dp,1._dp)*eta))
mat1a(2,1) = 0._dp 
...
sigS=0._dp 
p2 = MCha2(il) 
Call Sigma1LoopCha(p2,Mhh,Mhh2,MCha,MCha2,MVZ,MVZ2,MHpm,MHpm2,MChi,MChi2,             & 
& MVWm,MVWm2,MSu,MSu2,MFd,MFd2,MSv,MSv2,MFe,MFe2,MFu,MFu2,MSd,MSd2,MSe,MSe2,             & 
...
& cplcUChacFuSdR,cplcUChacFvSeL,cplcUChacFvSeR,sigL,sigR,sigS)
...
Subroutine Sigma1LoopCha(p2,Mhh,Mhh2,MCha,MCha2,MVZ,MVZ2,MHpm,MHpm2,MChi,             & 
& MChi2,MVWm,MVWm2,MSu,MSu2,MFd,MFd2,MSv,MSv2,MFe,MFe2,MFu,MFu2,MSd,MSd2,MSe,            & 
& MSe2,cplcUChaChahhL,cplcUChaChahhR,cplcUChaChaVPL,cplcUChaChaVPR,cplcUChaChaVZL,       & 
& cplcUChaChaVZR,cplcUChaChiHpmL,cplcUChaChiHpmR,cplcUChaChiVWmL,cplcUChaChiVWmR,        & 
& cplcUChaFdcSuL,cplcUChaFdcSuR,cplcUChaFecSvL,cplcUChaFecSvR,cplcUChacFuSdL,            & 
& cplcUChacFuSdR,cplcUChacFvSeL,cplcUChacFvSeR,sigL,sigR,sigS)
...
Subroutine OneLoopFe(Ye,vd,MSv,MSv2,MCha,MCha2,MSe,MSe2,MChi,MChi2,Mhh,               & 
& Mhh2,MFe,MFe2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,cplcUFeChaSvL,cplcUFeChaSvR,              & 
...
Implicit None 
Real(dp), Intent(in) :: MSv(3),MSv2(3),MCha(2),MCha2(2),MSe(6),MSe2(6),MChi(4),MChi2(4),Mhh(4),               & 
& Mhh2(4),MFe(3),MFe2(3),MVZ,MVZ2,MHpm(2),MHpm2(2),MVWm,MVWm2

Real(dp), Intent(in) :: vd

Complex(dp), Intent(in) :: Ye(3,3)

Complex(dp), Intent(in) :: cplcUFeChaSvL(3,2,3),cplcUFeChaSvR(3,2,3),cplcUFeChiSeL(3,4,6),cplcUFeChiSeR(3,4,6),  & 
...
sigS=0._dp 
p2 = MFe2(il) 
Call Sigma1LoopFe(p2,MSv,MSv2,MCha,MCha2,MSe,MSe2,MChi,MChi2,Mhh,Mhh2,MFe,            & 
& MFe2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,cplcUFeChaSvL,cplcUFeChaSvR,cplcUFeChiSeL,         & 
& cplcUFeChiSeR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,        & 
& cplcUFeFeVZR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvVWmL,cplcUFeFvVWmR,sigL,             & 
& sigR,sigS)
...
Subroutine Sigma1LoopFe(p2,MSv,MSv2,MCha,MCha2,MSe,MSe2,MChi,MChi2,Mhh,               & 
& Mhh2,MFe,MFe2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,cplcUFeChaSvL,cplcUFeChaSvR,              & 
& cplcUFeChiSeL,cplcUFeChiSeR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,       & 
& cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvVWmL,cplcUFeFvVWmR,     & 
& sigL,sigR,sigS)
...
Subroutine OneLoopFd(Yd,vd,MSu,MSu2,MCha,MCha2,MSd,MSd2,MChi,MChi2,Mhh,               & 
& Mhh2,MFd,MFd2,MVZ,MVZ2,MHpm,MHpm2,MFu,MFu2,MVWm,MVWm2,MGlu,MGlu2,cplcUFdChaSuL,        & 
& cplcUFdChaSuR,cplcUFdChiSdL,cplcUFdChiSdR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,      & 
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,        & 
...
Implicit None 
Real(dp), Intent(in) :: MSu(6),MSu2(6),MCha(2),MCha2(2),MSd(6),MSd2(6),MChi(4),MChi2(4),Mhh(4),               & 
& Mhh2(4),MFd(3),MFd2(3),MVZ,MVZ2,MHpm(2),MHpm2(2),MFu(3),MFu2(3),MVWm,MVWm2,            & 
& MGlu,MGlu2
...
Complex(dp), Intent(in) :: cplcUFdChaSuL(3,2,6),cplcUFdChaSuR(3,2,6),cplcUFdChiSdL(3,4,6),cplcUFdChiSdR(3,4,6),  & 
& cplcUFdFdhhL(3,3,4),cplcUFdFdhhR(3,3,4),cplcUFdFdVGL(3,3),cplcUFdFdVGR(3,3),           & 
& cplcUFdFdVPL(3,3),cplcUFdFdVPR(3,3),cplcUFdFdVZL(3,3),cplcUFdFdVZR(3,3),               & 
& cplcUFdFuHpmL(3,3,2),cplcUFdFuHpmR(3,3,2),cplcUFdFuVWmL(3,3),cplcUFdFuVWmR(3,3),       & 
...
sigS=0._dp 
p2 = MFd2(il) 
Call Sigma1LoopFd(p2,MSu,MSu2,MCha,MCha2,MSd,MSd2,MChi,MChi2,Mhh,Mhh2,MFd,            & 
& MFd2,MVZ,MVZ2,MHpm,MHpm2,MFu,MFu2,MVWm,MVWm2,MGlu,MGlu2,cplcUFdChaSuL,cplcUFdChaSuR,   & 
& cplcUFdChiSdL,cplcUFdChiSdR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,cplcUFdFdVGR,       & 
& cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,cplcUFdFuHpmR,       & 
& cplcUFdFuVWmL,cplcUFdFuVWmR,cplcUFdGluSdL,cplcUFdGluSdR,sigL,sigR,sigS)
...
Subroutine Sigma1LoopFd(p2,MSu,MSu2,MCha,MCha2,MSd,MSd2,MChi,MChi2,Mhh,               & 
& Mhh2,MFd,MFd2,MVZ,MVZ2,MHpm,MHpm2,MFu,MFu2,MVWm,MVWm2,MGlu,MGlu2,cplcUFdChaSuL,        & 
& cplcUFdChaSuR,cplcUFdChiSdL,cplcUFdChiSdR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,      & 
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,        & 
...
Subroutine OneLoopFu(Yu,eta,vu,MSu,MSu2,MChi,MChi2,MHpm,MHpm2,MFd,MFd2,               & 
& MVWm,MVWm2,Mhh,Mhh2,MFu,MFu2,MVZ,MVZ2,MGlu,MGlu2,MCha,MCha2,MSd,MSd2,cplcUFuChiSuL,    & 
& cplcUFuChiSuR,cplcUFuFdcHpmL,cplcUFuFdcHpmR,cplcUFuFdcVWmL,cplcUFuFdcVWmR,             & 
& cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,         & 
& cplcUFuFuVZL,cplcUFuFuVZR,cplcUFuGluSuL,cplcUFuGluSuR,cplcChacUFuSdL,cplcChacUFuSdR,   & 
...
Implicit None 
Real(dp), Intent(in) :: MSu(6),MSu2(6),MChi(4),MChi2(4),MHpm(2),MHpm2(2),MFd(3),MFd2(3),MVWm,MVWm2,           & 
& Mhh(4),Mhh2(4),MFu(3),MFu2(3),MVZ,MVZ2,MGlu,MGlu2,MCha(2),MCha2(2),MSd(6),MSd2(6)

Real(dp), Intent(in) :: eta,vu

Complex(dp), Intent(in) :: Yu(3,3)

Complex(dp), Intent(in) :: cplcUFuChiSuL(3,4,6),cplcUFuChiSuR(3,4,6),cplcUFuFdcHpmL(3,3,2),cplcUFuFdcHpmR(3,3,2),& 
& cplcUFuFdcVWmL(3,3),cplcUFuFdcVWmR(3,3),cplcUFuFuhhL(3,3,4),cplcUFuFuhhR(3,3,4),       & 
& cplcUFuFuVGL(3,3),cplcUFuFuVGR(3,3),cplcUFuFuVPL(3,3),cplcUFuFuVPR(3,3),               & 
& cplcUFuFuVZL(3,3),cplcUFuFuVZR(3,3),cplcUFuGluSuL(3,6),cplcUFuGluSuR(3,6),             & 
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(exp((0._dp,1._dp)*eta)*vu*Yu(1,1))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(exp((0._dp,1._dp)*eta)*vu*Yu(2,1))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(exp((0._dp,1._dp)*eta)*vu*Yu(3,1))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(exp((0._dp,1._dp)*eta)*vu*Yu(1,2))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(exp((0._dp,1._dp)*eta)*vu*Yu(2,2))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(exp((0._dp,1._dp)*eta)*vu*Yu(3,2))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(exp((0._dp,1._dp)*eta)*vu*Yu(1,3))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(exp((0._dp,1._dp)*eta)*vu*Yu(2,3))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(exp((0._dp,1._dp)*eta)*vu*Yu(3,3))/sqrt(2._dp)
...
sigS=0._dp 
p2 = MFu2(il) 
Call Sigma1LoopFu(p2,MSu,MSu2,MChi,MChi2,MHpm,MHpm2,MFd,MFd2,MVWm,MVWm2,              & 
...
Subroutine Sigma1LoopFu(p2,MSu,MSu2,MChi,MChi2,MHpm,MHpm2,MFd,MFd2,MVWm,              & 
& MVWm2,Mhh,Mhh2,MFu,MFu2,MVZ,MVZ2,MGlu,MGlu2,MCha,MCha2,MSd,MSd2,cplcUFuChiSuL,         & 
& cplcUFuChiSuR,cplcUFuFdcHpmL,cplcUFuFdcHpmR,cplcUFuFdcVWmL,cplcUFuFdcVWmR,             & 
& cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,         & 
& cplcUFuFuVZL,cplcUFuFuVZR,cplcUFuGluSuL,cplcUFuGluSuR,cplcChacUFuSdL,cplcChacUFuSdR,   & 
& sigL,sigR,sigS)
...
Subroutine OneLoopVZ(g1,g2,vd,vu,TW,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,               & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,               & 
& MSu,MSu2,MSv,MSv2,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,               & 
...
Complex(dp), Intent(in) :: cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplChiChiVZL(4,4),cplChiChiVZR(4,4),            & 
...
& cplSvcSvVZVZ(3,3),cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3
...
p2 = MVZ2
PiSf = ZeroC 
Call Pi1LoopVZ(p2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,               & 
& Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,               & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplcFdFdVZL,cplcFdFdVZR,         & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
& cplcgWmgWmVZ,cplcgWpCgWpCVZ,cplhhhhVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,             & 
...
Subroutine Pi1LoopVZ(p2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,             & 
& Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,           & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplcFdFdVZL,cplcFdFdVZR,         & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
& cplcgWmgWmVZ,cplcgWpCgWpCVZ,cplhhhhVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,             & 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 4
       Do i2 = 1, 4
 B22m2 = -4._dp*B00(p2,Mhh2(i2),Mhh2(i1))  
...
Subroutine OneLoopVWm(g2,vd,vu,MChi,MChi2,MCha,MCha2,MFu,MFu2,MFd,MFd2,               & 
& MFe,MFe2,MHpm,MHpm2,Mhh,Mhh2,MVWm,MVWm2,MVZ,MVZ2,MSu,MSu2,MSd,MSd2,MSv,MSv2,           & 
& MSe,MSe2,cplChiChacVWmL,cplChiChacVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFvFecVWmL,      & 
...
Complex(dp), Intent(in) :: cplChiChacVWmL(4,2),cplChiChacVWmR(4,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),        & 
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcgWpCgAcVWm,cplcgAgWmcVWm,cplcgZgWmcVWm,      & 
& cplcgWpCgZcVWm,cplhhHpmcVWm(4,2),cplhhcVWmVWm(4),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),      & 
& cplSdcSucVWm(6,6),cplSecSvcVWm(6,3),cplcVWmVPVWm,cplcVWmVWmVZ,cplhhhhcVWmVWm(4,4),     & 
& cplHpmcHpmcVWmVWm(2,2),cplSdcSdcVWmVWm(6,6),cplSecSecVWmVWm(6,6),cplSucSucVWmVWm(6,6), & 
& cplSvcSvcVWmVWm(3,3),cplcVWmVPVPVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmcVWmVWmVWm2,& 
...
p2 = MVWm2
PiSf = ZeroC 
Call Pi1LoopVWm(p2,MChi,MChi2,MCha,MCha2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MHpm,             & 
...
Subroutine Pi1LoopVWm(p2,MChi,MChi2,MCha,MCha2,MFu,MFu2,MFd,MFd2,MFe,MFe2,            & 
& MHpm,MHpm2,Mhh,Mhh2,MVWm,MVWm2,MVZ,MVZ2,MSu,MSu2,MSd,MSd2,MSv,MSv2,MSe,MSe2,           & 
...
Subroutine Sigma1LoopFeMZ(p2,MSv,MSv2,MCha,MCha2,MSe,MSe2,MChi,MChi2,Mhh,             & 
& Mhh2,MFe,MFe2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,cplcUFeChaSvL,cplcUFeChaSvR,              & 
& cplcUFeChiSeL,cplcUFeChiSeR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,       & 
& cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvVWmL,cplcUFeFvVWmR,     & 
& sigL,sigR,sigS)
...
Subroutine Sigma1LoopFdMZ(p2,MSu,MSu2,MCha,MCha2,MSd,MSd2,MChi,MChi2,Mhh,             & 
& Mhh2,MFd,MFd2,MVZ,MVZ2,MHpm,MHpm2,MFu,MFu2,MVWm,MVWm2,MGlu,MGlu2,cplcUFdChaSuL,        & 
& cplcUFdChaSuR,cplcUFdChiSdL,cplcUFdChiSdR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,      & 
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,        & 
& cplcUFdFuHpmR,cplcUFdFuVWmL,cplcUFdFuVWmR,cplcUFdGluSdL,cplcUFdGluSdR,sigL,            & 
...
Subroutine Sigma1LoopFuMZ(p2,MSu,MSu2,MChi,MChi2,MHpm,MHpm2,MFd,MFd2,MVWm,            & 
& MVWm2,Mhh,Mhh2,MFu,MFu2,MVZ,MVZ2,MGlu,MGlu2,MCha,MCha2,MSd,MSd2,cplcUFuChiSuL,         & 
& cplcUFuChiSuR,cplcUFuFdcHpmL,cplcUFuFdcHpmR,cplcUFuFdcVWmL,cplcUFuFdcVWmR,             & 
& cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,         & 
& cplcUFuFuVZL,cplcUFuFuVZR,cplcUFuGluSuL,cplcUFuGluSuR,cplcChacUFuSdL,cplcChacUFuSdR,   & 
