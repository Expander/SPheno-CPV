...
Subroutine ChiThreeBodyDecay(n_in,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,            & 
...
& me2,M1,M2,M3,vd,vu,gThh,gTHpm,gTSd,gTSe,gTSu,gTSv,gTVWm,gTVZ,gChiChicChaCha,           & 
& gChiChacFdFu,gChiChacFeFv,gChiChiChiChi,gChiChicFdFd,gChiChicFeFe,gChiChicFuFu,        & 
& gChiChicFvFv,gChiFdcFdGlu,gChiFucFuGlu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gChiChicChaCha(4,4,2,2),gChiChacFdFu(4,2,3,3),gChiChacFeFv(4,2,3,3),gChiChiChiChi(4,4,4,4),& 
& gChiChicFdFd(4,4,3,3),gChiChicFeFe(4,4,3,3),gChiChicFuFu(4,4,3,3),gChiChicFvFv(4,4,3,3),& 
& gChiFdcFdGlu(4,3,3,1),gChiFucFuGlu(4,3,3,1)

Real(dp),Intent(in) :: gThh(4),gTHpm(2),gTSd(6),gTSe(6),gTSu(6),gTSv(3),gTVWm,gTVZ

Real(dp) :: gChiChicChaChai(4,2,2),gChiChacFdFui(2,3,3),gChiChacFeFvi(2,3,3),gChiChiChiChii(4,4,4),& 
& gChiChicFdFdi(4,3,3),gChiChicFeFei(4,3,3),gChiChicFuFui(4,3,3),gChiChicFvFvi(4,3,3),   & 
& gChiFdcFdGlui(3,3,1),gChiFucFuGlui(3,3,1)

Real(dp) :: gThhtemp(4),gTHpmtemp(2),gTSdtemp(6),gTSetemp(6),gTSutemp(6),gTSvtemp(3)              & 
& ,gTVWmtemp,gTVZtemp
...
Call CouplingsFor_Chi_decays_3B(MChi(i_run),i_run,MCha,MCha2,MChi,MChi2,              & 
...
& mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,             & 
...
Call ChiToChicChaCha(i_run,MChi,MCha,MVZ,MVWm,MHpm,Mhh,cplcChaChahhL,cplcChaChahhR,   & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,cplcChaChiVWmL,              & 
& cplcChaChiVWmR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,            & 
...
& NSs,NSSss,NSSst,NVs,NVSss,NVSst,NVVss,NVVst,gTVZtemp,gTVWmtemp,gTHpmtemp,              & 
& gThhtemp,deltaM,epsI,check,gChiChicChaChai)
...
gChiChicFdFdi = 0._dp 
Call ChiToChicFdFd(i_run,MChi,MFd,MVZ,MSd,Mhh,cplcFdChiSdL,cplcFdChiSdR,              & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplChiChihhL,cplChiChihhR,             & 
& cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZtemp,gTSdtemp,gThhtemp,deltaM,epsI,check,              & 
& gChiChicFdFdi)
...
gChiChicFeFei = 0._dp 
Call ChiToChicFeFe(i_run,MChi,MFe,MVZ,MSe,Mhh,cplcFeChiSeL,cplcFeChiSeR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplChiChihhL,cplChiChihhR,             & 
& cplChiChiVZL,cplChiChiVZR,cplChiFecSeL,cplChiFecSeR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZtemp,gTSetemp,gThhtemp,deltaM,epsI,check,              & 
& gChiChicFeFei)
...
gChiChicFuFui = 0._dp 
Call ChiToChicFuFu(i_run,MChi,MFu,MVZ,MSu,Mhh,cplcFuChiSuL,cplcFuChiSuR,              & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplChiChihhL,cplChiChihhR,             & 
& cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,cplChiFucSuR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZtemp,gTSutemp,gThhtemp,deltaM,epsI,check,              & 
& gChiChicFuFui)
...
Subroutine ChiToChicChaCha(iIN,MChi,MCha,MVZ,MVWm,MHpm,Mhh,cplcChaChahhL,             & 
& cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,               & 
& cplcChaChiVWmL,cplcChaChiVWmR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,            & 
& cplChiChacVWmR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,IntegralSs,         & 
...
Real(dp),Intent(in) :: MChi(4),MCha(2),MVZ,MVWm,MHpm(2),Mhh(4)
...
Real(dp),Intent(inout) :: gTVZ,gTVWm,gTHpm(2),gThh(4)
...
Real(dp),Intent(in) :: MChi(4),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplChiChihhL(4,4,4),cplChiChihhR(4,4,4),cplChiChiVZL(4,4),cplChiChiVZR(4,4)
...
Real(dp),Intent(inout) :: gTVZ,gThh(4)
...
Subroutine ChiToChicFdFd(iIN,MChi,MFd,MVZ,MSd,Mhh,cplcFdChiSdL,cplcFdChiSdR,          & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplChiChihhL,cplChiChihhR,             & 
& cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZ,gTSd,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MChi(4),MFd(3),MVZ,MSd(6),Mhh(4)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),        & 
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplChiChihhL(4,4,4),cplChiChihhR(4,4,4),             & 
& cplChiChiVZL(4,4),cplChiChiVZR(4,4),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6)
...
Real(dp),Intent(inout) :: gTVZ,gTSd(6),gThh(4)
...
Subroutine ChiToChicFeFe(iIN,MChi,MFe,MVZ,MSe,Mhh,cplcFeChiSeL,cplcFeChiSeR,          & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplChiChihhL,cplChiChihhR,             & 
& cplChiChiVZL,cplChiChiVZR,cplChiFecSeL,cplChiFecSeR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZ,gTSe,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MChi(4),MFe(3),MVZ,MSe(6),Mhh(4)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,4,6),cplcFeChiSeR(3,4,6),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),        & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplChiChihhL(4,4,4),cplChiChihhR(4,4,4),             & 
...
Real(dp),Intent(inout) :: gTVZ,gTSe(6),gThh(4)
...
Subroutine ChiToChicFuFu(iIN,MChi,MFu,MVZ,MSu,Mhh,cplcFuChiSuL,cplcFuChiSuR,          & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplChiChihhL,cplChiChihhR,             & 
& cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,cplChiFucSuR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZ,gTSu,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MChi(4),MFu(3),MVZ,MSu(6),Mhh(4)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,4,6),cplcFuChiSuR(3,4,6),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),        & 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplChiChihhL(4,4,4),cplChiChihhR(4,4,4),             & 
...
Real(dp),Intent(inout) :: gTVZ,gTSu(6),gThh(4)
