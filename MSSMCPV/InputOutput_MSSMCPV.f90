...
Complex(dp) :: PDGSd(6),PDGSu(6),PDGSe(6),PDGSv(3),PDGhh(4),PDGHpm(2),PDGVP,PDGVZ,PDGVG,             & 
& PDGVWm,PDGgP,PDGgWm,PDGgWmC,PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),           & 
& PDGGlu,PDGChi(4),PDGCha(2)
...
Write(io_L,101) 6, Real(etaInput,dp) ,"# etaInput"
...
Write(io_L,106) "Block IMCHARGEMIX Q=",Q,"# ()" 
...
icount = icount +1 
  End Do 
If (Maxval(BRSv(1,43:891)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,4
...
icount = icount +1 
  End Do 
If (Maxval(BRSv(2,43:891)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,4
...
icount = icount +1 
  End Do 
If (Maxval(BRSv(3,43:891)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,4
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleSe(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSv(gt2) 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleSv(gt1))//"^* "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.MSSMCPV",status="unknown")
...
End Module InputOutput_MSSMCPV 
