...
Subroutine DeltaVB(sinW2,sinW2_dr,rho,MCha,MChi,MFe,Mhh,MHpm,MSe,MSv,MVWm,            & 
...
Complex(dp) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChiVWmL(2,4),cplcChaChiVWmR(2,4),    & 
...
& cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiFecSeL(4,3,6),cplChiFecSeR(4,3,6),       & 
& cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplhhcHpmVWm(4,2),cplhhcVWmVWm(4),             & 
& cplSvcSeVWm(3,6)
...
End Module LoopCouplings_MSSMCPV 
