...
Subroutine SvThreeBodyDecay(n_in,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,             & 
...
& me2,M1,M2,M3,vd,vu,gSvSvChiChi,gSvcHpmChiFe,gSvSeChicCha,gSvFeFucSd,gSvFeFvcSe,        & 
...
& gSvSvChacCha,gSvSvFdcFd,gSvSvFucFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gSvSvChiChi(3,3,4,4),gSvcHpmChiFe(3,2,4,3),gSvSeChicCha(3,6,4,2),gSvFeFucSd(3,3,3,6), & 
& gSvFeFvcSe(3,3,3,6),gSvhhFecCha(3,4,3,2),gSvFeSucFd(3,3,6,3),gSvSvFecFe(3,3,3,3),      & 
& gSvcHpmChaFv(3,2,2,3),gSvhhChiFv(3,4,4,3),gSvFvFdcSd(3,3,3,6),gSvFvFucSu(3,3,3,6),     & 
...
Real(dp) :: gSvSvChiChii(3,4,4),gSvcHpmChiFei(2,4,3),gSvSeChicChai(6,4,2),gSvFeFucSdi(3,3,6),     & 
& gSvFeFvcSei(3,3,6),gSvhhFecChai(4,3,2),gSvFeSucFdi(3,6,3),gSvSvFecFei(3,3,3),          & 
& gSvcHpmChaFvi(2,2,3),gSvhhChiFvi(4,4,3),gSvFvFdcSdi(3,3,6),gSvFvFucSui(3,3,6),         & 
& gSvFvFvcSvi(3,3,3),gSvcChaFvHpmi(2,3,2),gSvFvSdcFdi(3,6,3),gSvSeFvcFei(6,3,3),         & 
& gSvFvSucFui(3,6,3),gSvSvFvcFvi(3,3,3),gSvSeFucFdi(6,3,3),gSvSvChacChai(3,2,2),         & 
& gSvSvFdcFdi(3,3,3),gSvSvFucFui(3,3,3)
...
Call CouplingsFor_Sv_decays_3B(MSv(i_run),i_run,MCha,MCha2,MChi,MChi2,MFd,            & 
...
& mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChacFvSeL,cplcChacFvSeR,cplcChaChahhL,             & 
...
Real(dp),Intent(in) :: MSv(3),MChi(4),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplSvcSvVZ(3,3),cplcFvChiSvL(3,4,3),cplcFvChiSvR(3,4,3),            & 
...
Real(dp),Intent(in) :: Mhh(4),MFe(3),MCha(2),MSv(3)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaFecSvL(2,3,3),     & 
& cplcChaFecSvR(2,3,3),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4)
...
Real(dp),Intent(in) :: MSv(3),MFe(3),MVZ,Mhh(4),MCha(2)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplSvcSvVZ(3,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),          & 
& cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),         & 
...
Real(dp),Intent(in) :: Mhh(4),MChi(4),MSv(3)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplChiChihhL(4,4,4),cplChiChihhR(4,4,4),cplChiFvcSvL(4,3,3),        & 
& cplChiFvcSvR(4,3,3)
...
Real(dp),Intent(in) :: MSv(3),MCha(2),MVZ,Mhh(4),MFe(3)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplSvcSvVZ(3,3),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),          & 
...
Real(dp),Intent(in) :: MSv(3),MFd(3),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplSvcSvVZ(3,3),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),              & 
...
Real(dp),Intent(in) :: MSv(3),MFu(3),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSvcSv(4,3,3),cplSvcSvVZ(3,3),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),              & 
