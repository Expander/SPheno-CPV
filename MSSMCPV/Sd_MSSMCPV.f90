...
Subroutine SdThreeBodyDecay(n_in,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,             & 
...
& me2,M1,M2,M3,vd,vu,gSdSuChaChi,gSdChaFdcHpm,gSdhhChaFu,gSdChaGluSu,gSdSdChacCha,       & 
...
Real(dp),Intent(inout) :: gSdSuChaChi(6,6,2,4),gSdChaFdcHpm(6,2,3,2),gSdhhChaFu(6,4,2,3),gSdChaGluSu(6,2,1,6),  & 
& gSdSdChacCha(6,6,2,2),gSdSdChiChi(6,6,4,4),gSdhhChiFd(6,4,4,3),gSdHpmChiFu(6,2,4,3),   & 
& gSdChiGluSd(6,4,1,6),gSdFdFdcSd(6,3,3,6),gSdFdFecSe(6,3,3,6),gSdFuFdcSu(6,3,3,6),      & 
& gSdFdFvcSv(6,3,3,3),gSdHpmFdcCha(6,2,3,2),gSdSdFdcFd(6,6,3,3),gSdFdSecFe(6,3,6,3),     & 
& gSdSuFdcFu(6,6,3,3),gSdFdSvcFv(6,3,3,3),gSdFuFecSv(6,3,3,3),gSdSdFucFu(6,6,3,3),       & 
& gSdFuSecFv(6,3,6,3),gSdhhFdGlu(6,4,3,1),gSdHpmFuGlu(6,2,3,1),gSdGluGluSd(6,1,1,6),     & 
& gSdSdFecFe(6,6,3,3),gSdSdFvcFv(6,6,3,3),gSdSuFecFv(6,6,3,3)

Real(dp) :: gSdSuChaChii(6,2,4),gSdChaFdcHpmi(2,3,2),gSdhhChaFui(4,2,3),gSdChaGluSui(2,1,6),      & 
& gSdSdChacChai(6,2,2),gSdSdChiChii(6,4,4),gSdhhChiFdi(4,4,3),gSdHpmChiFui(2,4,3),       & 
& gSdChiGluSdi(4,1,6),gSdFdFdcSdi(3,3,6),gSdFdFecSei(3,3,6),gSdFuFdcSui(3,3,6),          & 
& gSdFdFvcSvi(3,3,3),gSdHpmFdcChai(2,3,2),gSdSdFdcFdi(6,3,3),gSdFdSecFei(3,6,3),         & 
& gSdSuFdcFui(6,3,3),gSdFdSvcFvi(3,3,3),gSdFuFecSvi(3,3,3),gSdSdFucFui(6,3,3),           & 
& gSdFuSecFvi(3,6,3),gSdhhFdGlui(4,3,1),gSdHpmFuGlui(2,3,1),gSdGluGluSdi(1,1,6),         & 
& gSdSdFecFei(6,3,3),gSdSdFvcFvi(6,3,3),gSdSuFecFvi(6,3,3)
...
Call CouplingsFor_Sd_decays_3B(MSd(i_run),i_run,MCha,MCha2,MChi,MChi2,MFd,            & 
...
& mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,             & 
...
& cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,            & 
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdGluSdL,cplcFdGluSdR,cplcFeChiSeL,          & 
& cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuChiSuL,             & 
...
gSdSdChacChai = 0._dp 
Call SdToSdChacCha(i_run,MSd,MCha,MVZ,Mhh,MFu,cplhhSdcSd,cplSdcSdVZ,cplcChacFuSdL,    & 
& cplcChacFuSdR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplChaFucSdL,    & 
& cplChaFucSdR,deltaM,epsI,check,gSdSdChacChai)

gSdSdChacCha(i_run,:,:,:) = gSdSdChacChai 
gT(i_run) = gT(i_run) + Sum(gSdSdChacChai) 
 
gSdSdChiChii = 0._dp 
Call SdToSdChiChi(i_run,MSd,MChi,MVZ,Mhh,MFd,cplhhSdcSd,cplSdcSdVZ,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,         & 
& cplChiFdcSdR,deltaM,epsI,check,gSdSdChiChii)
...
gSdSdFdcFdi = 0._dp 
Call SdToSdFdcFd(i_run,MSd,MFd,MVZ,Mhh,MChi,MGlu,cplhhSdcSd,cplSdcSdVZ,               & 
...
gSdSdFucFui = 0._dp 
Call SdToSdFucFu(i_run,MSd,MFu,MVZ,Mhh,MCha,cplhhSdcSd,cplSdcSdVZ,cplcChacFuSdL,      & 
& cplcChacFuSdR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplChaFucSdL,            & 
& cplChaFucSdR,deltaM,epsI,check,gSdSdFucFui)
...
gSdSdFecFei = 0._dp 
Call SdToSdFecFe(i_run,MSd,MFe,MVZ,Mhh,cplhhSdcSd,cplSdcSdVZ,cplcFeFehhL,             & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,deltaM,epsI,check,gSdSdFecFei)
...
Real(dp),Intent(in) :: Mhh(4),MCha(2),MFu(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcFuFuhhL(3,3,4),       & 
& cplcFuFuhhR(3,3,4),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6)
...
Subroutine SdToSdChacCha(iIN,MSd,MCha,MVZ,Mhh,MFu,cplhhSdcSd,cplSdcSdVZ,              & 
& cplcChacFuSdL,cplcChacFuSdR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,   & 
& cplChaFucSdL,cplChaFucSdR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MCha(2),MVZ,Mhh(4),MFu(3)

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),          & 
& cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),       & 
...
Subroutine SdToSdChiChi(iIN,MSd,MChi,MVZ,Mhh,MFd,cplhhSdcSd,cplSdcSdVZ,               & 
& cplcFdChiSdL,cplcFdChiSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
& cplChiFdcSdL,cplChiFdcSdR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MChi(4),MVZ,Mhh(4),MFd(3)

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),            & 
...
Real(dp),Intent(in) :: Mhh(4),MChi(4),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplChiChihhL(4,4,4),          & 
& cplChiChihhR(4,4,4),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6)
...
Subroutine SdToSdFdcFd(iIN,MSd,MFd,MVZ,Mhh,MChi,MGlu,cplhhSdcSd,cplSdcSdVZ,           & 
& cplcFdChiSdL,cplcFdChiSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFdGluSdL,cplcFdGluSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,cplGluFdcSdR,         & 
& deltaM,epsI,check,g,WriteContributions)
...
Real(dp),Intent(in) :: MSd(6),MFd(3),MVZ,Mhh(4),MChi(4),MGlu

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),            & 
& cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),           & 
...
Subroutine SdToSdFucFu(iIN,MSd,MFu,MVZ,Mhh,MCha,cplhhSdcSd,cplSdcSdVZ,cplcChacFuSdL,  & 
& cplcChacFuSdR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplChaFucSdL,            & 
& cplChaFucSdR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MFu(3),MVZ,Mhh(4),MCha(2)
...
Real(dp),Intent(in) :: Mhh(4),MFd(3),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplGluFdcSdL(3,6),            & 
& cplGluFdcSdR(3,6)
...
Subroutine SdToSdFecFe(iIN,MSd,MFe,MVZ,Mhh,cplhhSdcSd,cplSdcSdVZ,cplcFeFehhL,         & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MFe(3),MVZ,Mhh(4)

Complex(dp),Intent(in) :: cplhhSdcSd(4,6,6),cplSdcSdVZ(6,6),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),              & 
