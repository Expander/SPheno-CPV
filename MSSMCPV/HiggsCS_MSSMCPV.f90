...
Implicit None 
Real(dp), Intent(in) :: mh(4)  
Complex(dp), Intent(in) :: ratPP(4), ratGG(4)  
Real(dp), Intent(in) :: ratZZ(4), ratWW(4), ratTT(4)  
Real(dp), Intent(Out) :: CS(2,4,5)  
