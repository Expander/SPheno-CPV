...
Subroutine ChaThreeBodyDecay(n_in,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,            & 
...
& me2,M1,M2,M3,vd,vu,gThh,gTHpm,gTSd,gTSe,gTSu,gTSv,gTVWm,gTVZ,gChaChacChaCha,           & 
& gChaChaChiChi,gChaChacFdFd,gChaChacFeFe,gChaChacFuFu,gChaChacFvFv,gChaChicFuFd,        & 
& gChaChicFvFe,gChaFdcFuGlu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Call CouplingsFor_Cha_decays_3B(MCha(i_run),i_run,MCha,MCha2,MChi,MChi2,              & 
...
& cplcChaFecSvL,cplcChaFecSvR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdhhL,cplcFdFdhhR,         & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeChaSvL,cplcFeChaSvR,cplcFeFehhL,cplcFeFehhR,             & 
...
Call ChaToChacChaCha(i_run,MCha,MVZ,Mhh,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,    & 
& cplcChaChaVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,IntegralVSss,            & 
& IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,NVSss,NVSst,NVVss,          & 
& NVVst,gTVZtemp,gThhtemp,deltaM,epsI,check,gChaChacChaChai)

gChaChacChaCha(i_run,:,:,:) = gChaChacChaChai 
gT(i_run) = gT(i_run) + Sum(gChaChacChaChai) 
 
gChaChaChiChii = 0._dp 
Call ChaToChaChiChi(i_run,MCha,MChi,MVZ,MVWm,MHpm,Mhh,cplcChaChahhL,cplcChaChahhR,    & 
...
& gThhtemp,deltaM,epsI,check,gChaChaChiChii)

gChaChaChiChi(i_run,:,:,:) = gChaChaChiChii 
gT(i_run) = gT(i_run) + Sum(gChaChaChiChii) 
 
gChaChacFdFdi = 0._dp 
Call ChaToChacFdFd(i_run,MCha,MFd,MVZ,MSu,Mhh,cplcChaChahhL,cplcChaChahhR,            & 
...
gChaChacFeFei = 0._dp 
Call ChaToChacFeFe(i_run,MCha,MFe,MVZ,MSv,Mhh,cplcChaChahhL,cplcChaChahhR,            & 
...
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZtemp,gTSvtemp,gThhtemp,deltaM,epsI,check,              & 
& gChaChacFeFei)
...
gChaChacFuFui = 0._dp 
Call ChaToChacFuFu(i_run,MCha,MFu,MVZ,MSd,Mhh,cplcChacFuSdL,cplcChacFuSdR,            & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcFuFuhhL,cplcFuFuhhR,       & 
& cplcFuFuVZL,cplcFuFuVZR,cplChaFucSdL,cplChaFucSdR,IntegralSs,IntegralSSss,             & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
...
Subroutine ChaToChacChaCha(iIN,MCha,MVZ,Mhh,cplcChaChahhL,cplcChaChahhR,              & 
& cplcChaChaVZL,cplcChaChaVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,           & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
& NVSss,NVSst,NVVss,NVVst,gTVZ,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MCha(2),MVZ,Mhh(4)
...
Subroutine ChaToChaChiChi(iIN,MCha,MChi,MVZ,MVWm,MHpm,Mhh,cplcChaChahhL,              & 
...
Real(dp),Intent(in) :: MCha(2),MChi(4),MVZ,MVWm,MHpm(2),Mhh(4)
...
Subroutine ChaToChacFdFd(iIN,MCha,MFd,MVZ,MSu,Mhh,cplcChaChahhL,cplcChaChahhR,        & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,     & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,IntegralSs,IntegralSSss,               & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
...
Real(dp),Intent(in) :: MCha(2),MFd(3),MVZ,MSu(6),Mhh(4)
...
Subroutine ChaToChacFeFe(iIN,MCha,MFe,MVZ,MSv,Mhh,cplcChaChahhL,cplcChaChahhR,        & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,cplcFeChaSvL,cplcFeChaSvR,     & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,IntegralSs,IntegralSSss,               & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVZ,gTSv,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MCha(2),MFe(3),MVZ,MSv(3),Mhh(4)
...
Real(dp),Intent(inout) :: gTVZ,gTSv(3),gThh(4)
...
Subroutine ChaToChacFuFu(iIN,MCha,MFu,MVZ,MSd,Mhh,cplcChacFuSdL,cplcChacFuSdR,        & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcFuFuhhL,cplcFuFuhhR,       & 
& cplcFuFuVZL,cplcFuFuVZR,cplChaFucSdL,cplChaFucSdR,IntegralSs,IntegralSSss,             & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
...
Real(dp),Intent(in) :: MCha(2),MFu(3),MVZ,MSd(6),Mhh(4)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),  & 
& cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),           & 
