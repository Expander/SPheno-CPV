...
Complex(dp) :: cplhhhhSdcSd(4,4,6,6),cplhhhhSecSe(4,4,6,6),cplhhhhSucSu(4,4,6,6),cplhhHpmSucSd(4,2,6,6),& 
...
Call CouplingsFor2LPole3(Mu,Yd,Td,eta,vd,ZD,ZH,Ye,Te,ZE,Yu,Tu,vu,ZU,ZP,               & 
...
Call CouplingsFor2LPole4(Yd,ZD,ZH,Ye,ZE,Yu,ZU,eta,ZP,ZV,g3,cplhhhhSdcSd,              & 
& cplhhhhSecSe,cplhhhhSucSu,cplhhHpmSucSd,cplhhHpmSvcSe,cplhhSdcHpmcSu,cplhhSecHpmcSv,   & 
& cplHpmSdcHpmcSd,cplHpmSecHpmcSe,cplHpmSucHpmcSu,cplHpmSvcHpmcSv,cplSdSdcSdcSd,         & 
& cplSdSecSdcSe,cplSdSucSdcSu,cplSdSvcSecSu,cplSeSecSecSe,cplSeSucSdcSv,cplSeSvcSecSv,   & 
& cplSuSucSucSu)
