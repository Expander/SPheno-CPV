...
Real(dp) :: ratioCha(4,2),ratioFd(4,3),ratioFe(4,3),ratioFu(4,3),ratioHpm(4,2),ratioSd(4,6),      & 
& ratioSe(4,6),ratioSu(4,6),ratioVWm(4)

Complex(dp) :: ratioGG(4),ratioPP(4)

Real(dp) :: ratioPCha(99,2),ratioPFd(99,3),ratioPFe(99,3),ratioPFu(99,3),ratioPHpm(99,2),         & 
& ratioPSd(99,6),ratioPSe(99,6),ratioPSu(99,6),ratioPVWm(99)
...
Real(dp) :: BRHHH(4,4), BRHAA(4,99) 
 Real(dp) :: BRAHH(99,4), BRAAA(99,99) 
 Real(dp) :: BRinvH(4), BRinvA(99) 
Real(dp) :: rHB_P_P_Fe(99,3),rHB_P_S_Fe(99,3),rHB_S_S_Fe(4,3),rHB_S_P_Fe(4,3)
Real(dp) :: rHB_P_P_Fu(99,3),rHB_P_S_Fu(99,3),rHB_S_S_Fu(4,3),rHB_S_P_Fu(4,3)
Real(dp) :: rHB_P_P_Fd(99,3),rHB_P_S_Fd(99,3),rHB_S_S_Fd(4,3),rHB_S_P_Fd(4,3)
Real(dp) :: rHB_P_VP(99),rHB_S_VP(4)
Real(dp) :: rHB_P_VZ(99),rHB_S_VZ(4)
Real(dp) :: rHB_P_VG(99),rHB_S_VG(4)
Real(dp) :: rHB_P_VWm(99),rHB_S_VWm(4)
Real(dp) :: rHB_P_P_Fv(99),rHB_P_S_Fv(99),rHB_S_S_Fv(4),rHB_S_P_Fv(4)
Complex(dp) :: CPL_H_H_Z(4,4) 
 Complex(dp) :: CoupHPP(4), CoupHGG(4) 
Real(dp) :: HPPloopVWm(4)
Real(dp) :: HPPloopSd(6,4)
Real(dp) :: HPPloopSu(6,4)
Real(dp) :: HPPloopSe(6,4)
Real(dp) :: HPPloopHpm(2,4)
Real(dp) :: HPPloopCha(2,4)
