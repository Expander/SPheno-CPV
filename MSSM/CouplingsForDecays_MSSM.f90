...
& ratPSd,ratPSe,ratPSu,ratPVWm,MCha,MFd,MFe,MFu,MHpm,MVWm,MSd,MSe,MSu,coup)

cplPseudoHiggsPP(i1) = 2._dp*coup*Alpha 
CoupAPP(i1) = 2._dp*coup 
Call CoupPseudoHiggsToPhotonSM(m_in,MCha,MFd,MFe,MFu,MHpm,MVWm,MSd,MSe,MSu,coup)
